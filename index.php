...
<form class="login" id="form1" name="form1" method="post" action="MenuIndex.php" onSubmit="return validateCode(this);">
...
<input id="username" class="textfield" type="text" size="24" value="" name="username" onKeyUp="javascript:validateCode(event);">
</div>
<div class="item">
...
<h1>
    <font size="-3"><font color="838383">
This website and its content is copyright of Hospital La Carlota
<b xml:lang="en" dir="ltr">-&#169; Hospital La Carlota 2008. All rights reserved.</b>
    </font></font>
</h1>
</body>
</html>
