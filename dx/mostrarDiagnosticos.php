  ...
  <form id="form2" name="form2" method="get" action="">
    <table width="757" border="0" align="center">
      <tr>
        ...
        <th width="25" bgcolor="#660066" scope="col"><div align="left"><span class="style11">R</span></div></th>
...
?>
        ...
        <td bgcolor="<?php echo $color;?>" class="Estilo24"><span class="style12"><span class="style7">
		<a href="#" onClick="javascript:ventanaSecundaria('recetaCEX.php?numeroExpediente=<?php echo $numeroE; ?>
