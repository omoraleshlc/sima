...
$pdf->SetX(2);
$pdf->Cell(0,0,"IVA VENTAS DIRECTAS",0,0,M);
$pdf->SetX(1); 
...
$pdf->Ln(10); //salto de linea
$pdf->SetX(2);
$pdf->Cell(0,0,"VENTAS DIRECTAS SIN IVA",0,0,M);
$pdf->SetX(1); 
...
$pagoEfectivo1=$myrowefectivo['cargosParticular']-$myrowefectivod['devolucionesParticular'];
$totalEfectivo1[0]+=$myrowefectivo['cargosParticular']-$myrowefectivod['devolucionesParticular'];
//****************************************************************
...
//*************************************************************************
$pdf->SetX('170');
$pdf->Cell(0,0,'$'.number_format($pagoEfectivo1,2),0,0,M);
...
$ivaEfectivo1=$myrowivaE['ivaEfectivo']-$myrowdiE['devolucionIVAEfectivo'];
$totalIVAEfectivo1[0]+=$myrowivaE['ivaEfectivo']-$myrowdiE['devolucionIVAEfectivo'];
...
$pdf->Cell(0,0,"IVA",0,0,M);
$pdf->SetX('170');
$pdf->Cell(0,0,'$'.number_format($ivaEfectivo1,2),0,0,M);
}
//****************************************CIERRE EFECTIVO**********************************
...
$pdf->Cell(0,0,'IVA',0,0,M);
$pdf->SetX('90');
$pdf->Cell(0,0,'$'.number_format($totalIVAEfectivo1[0],2),0,0,M);
...
$pdf->Cell(0,0,'TOTAL',0,0,M);
$pdf->SetX('90');
$pdf->Cell(0,0,'$'.number_format($totalEfectivo1[0]+$totalIVAEfectivo1[0],2),0,0,M);
