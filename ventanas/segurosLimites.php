...
$sqld = "UPDATE segurosLimites set
...
echo mysql_error();
echo '<script>
window.alert("Se actualizo la cantidad!");
</script>';
...
<h1 align="center" class="titulos">Limites de Seguro</h1>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <label></label>  
  <div align="center">Limite
  
<?php 
$sSQL3a= "Select * From segurosLimites WHERE entidad='".$entidad."' and seguro = '".$_GET['numCliente']."'   ";
$result3a=mysql_db_query($basedatos,$sSQL3a);
$myrow3a = mysql_fetch_array($result3a);
?>

    <input name="cantidad" type="text" value="<?php  echo $myrow3a['cantidad'];?>" size="10" />
    </div>
