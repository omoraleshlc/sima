...
$pdf->SetXY(2,5);
$pdf->Cell(0,0,'VENTAS POR PAQUETES ',0,0,M);
$pdf->SetX(1);
...
//}
 ...
 $sSQLc= "SELECT count(*) as c FROM clientesInternos
WHERE
entidad='".$_GET['entidad']."'
    and
...
$pdf->SetX('15');
$pdf->Cell(0,0,$myrow['descripcionpaquete'],0,0,M);
