...
$sSQLdg= "Select * From polizas where entidad='".$_GET['entidad']."' and almacenIngreso='".$myrow['almacenIngreso']."'
...
$sSQL= "Select * From polizas where
    entidad='".$_GET['entidad']."'
...
//EFECTIVO
$devoluciones=$devcash[0]+$devoluciontc[0]+$devcheques[0]+$devte[0];
