...
$pdf->SetXY(2,30);
$pdf->Cell(0,0,'#Fac',0,0,M);

$pdf->SetXY(20,30);
$pdf->Cell(0,0,'Proveedor',0,0,M);
...
$pdf->SetX('2');
$pdf->Cell(0,0,$myrow['factura'],0,0,M);	

$pdf->SetX('20');
$pdf->Cell(0,0,$myrow['descripcionProveedor'],0,0,M);	
...
$pdf->SetX('150');
$pdf->Cell(0,0,'$'.number_format($myrow['importe'],2),0,0,M);
$sumaImporte[0]+=$myrow['importe'];
$pdf->SetX('165');
$pdf->Cell(0,0,'$'.number_format($myrow['iva'],2),0,0,M);
$sumaIva[0]+=$myrow['iva'];

$pdf->SetX('180');
$pdf->Cell(0,0,'$'.number_format($myrow['importe']+$myrow['iva'],2),0,0,M);
