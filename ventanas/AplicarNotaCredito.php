...
$s= "Select * From catTTCaja WHERE codigoTT='APNC'   ";
...
$s= "Select * From catTTCaja WHERE codigoTT='APNCD'   ";
$rs=mysql_db_query($basedatos,$s);
$my = mysql_fetch_array($rs);
$describe=$my['descripcion'];
$naturaleza=$my['naturaleza'];
...
numMovimiento,fechaCierre,numSolicitud,notaCredito,statusCuenta)
values 
('','','transaccion',
...
'".$numCorte."','".$statusDevolucion." ' ,'".$tipoCuenta."' ,'".$describe."','".$random."' ,'pagosCxC','si', '".$myrow333a['CVI']."',
    '".$fecha1."','".$n."','si','notaCredito') ";
mysql_db_query($basedatos,$agrega);
echo mysql_error();
//******************PARTIDA DOBLE******************************
...
keyCAP,codPaquete,transaccion,numRecibo,statusPago,notaCredito,usuario,statusDevolucion
...
<br />
  <form id="form1" name="form1" method="post" action="">
    ...
    <tr>
      ...
      <th colspan="3"   scope="col"><p align="center">Aplicar Nota de Credito</p></th>
    </tr>
