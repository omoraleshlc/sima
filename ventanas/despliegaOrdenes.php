...
<form id="form1" name="form1" method="post" action="">
  ...
  <p align="center">&nbsp;</p>
  <img src="../imagenes/bordestablas/borde1.png" width="520" height="24" />
  <table width="520" border="0" align="center" cellpadding="4" cellspacing="0">
    <tr>
      <th width="35" bgcolor="#FFFF00" scope="col"><div align="left" class="none">Req.</div></th>
      <th width="230" bgcolor="#FFFF00" scope="col"><div align="left" class="none">Descripci&oacute;n</div></th>
      <th width="62" bgcolor="#FFFF00" scope="col"><div align="left" class="none">Cantidad</div></th>
      <th width="77" bgcolor="#FFFF00" scope="col"><div align="left" class="none">Precio U.</div></th>
      <th width="49" bgcolor="#FFFF00" scope="col"><div align="left" class="none">Status </div></th>
      <th width="41" bgcolor="#FFFF00" scope="col"><div align="left" class="none">Imprimir</div></th>
    </tr>
    <tr>
<?php	
...
?>
      ...
      <td bgcolor="<?php echo $color?>" class="negromid"><?php echo $myrow18['descripcion']; ?></span></td>
      ...
      <td bgcolor="<?php echo $color?>" class="negromid"><span class="Estilo24"><span class="style7"><?php echo '$'.number_format($myrow18['precioUnitario'],2); ?></span></span></td>
      <td bgcolor="<?php echo $color?>" class="negromid"><?php echo $myrow18['status']; ?></span></td>
      <td bgcolor="<?php echo $color?>" class="style12"><label>
        <div align="center"><a href="javascript:ventanaSecundaria('listadoOrdenesImpresion.php?keyR=<?php echo $myrow18['keyR']; ?>&amp;id_proveedor=<?php echo $id_proveedor; ?>&amp;id_requisicion=<?php echo $requisicion; ?>&amp;usuario=<?php echo $usuario; ?>&amp;almacen=<?php echo $ali; ?>')"><img src="../../imagenes/btns/printbtn.png" alt="Imprimir " width="22" height="20" border="0" /></a></div>
      </label></td>
    </tr>
    <?php  }} //cierra while ?>
  </table>
  <img src="../imagenes/bordestablas/borde2.png" width="520" height="24" />
