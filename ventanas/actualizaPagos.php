...
<?php
echo 'Fecha del Sistema: '.cambia_a_normal($fecha1);
...
if($_POST['cambiar']   ){
    ...
    INSERT INTO solicitudesHistorial(numSolicitud,usuario,fecha,entidad,keyClientesInternos,hora)
    SELECT(IFNULL((SELECT MAX(numSolicitud)+1 from solicitudesHistorial where entidad='".$entidad."'), 1)), '".$usuario."',
    ...
    //**********COMPROBANDO 1era ITERACION*************
$sSQL1comp= "Select * From historialHeading WHERE keyClientesInternos='".$_GET['keyClientesInternos']."'";
$result1comp=mysql_db_query($basedatos,$sSQL1comp);
$myrow1comp = mysql_fetch_array($result1comp);    
    
 if(!$myrow1comp['folioVenta']){
     //******HISTORIAL CAMBIOS******

$agrega = "INSERT INTO historialHeading ( 
numeroE,nCuenta,
medico,paciente,
seguro,credencial,
...
'".$myrow1['numeroEx']."','".$nCuenta."',
'".$myrow1['medico']."',
'".strtoupper($myrow1['paciente'])."',
'".$myrow1['seguro']."',
'".$myrow1['credencial']."',
'".$fecha1."',
'".$hora1."',
...
'".$usuario."',
'".$ip."',
'".$fecha1."','".$myrow1['tipoConsulta']."','".$myrow1['medicoForaneo']."','".strtoupper($myrow1['observaciones'])."','".$myrow1['edad']."','".$myrow1['tipoPaciente']."',
'".$myrow1['nOrden']."','".$myrow1['statusExpediente']."','".$myrow1['dependencia']."','".$entidad."','".$myrow1['diagnostico']."','".$myrow1['telefono']."','".$myrow1['folioVenta']."',
'".$cP."','".$myrow1['statusPaciente']."',
'".$myrow1['tipoAccidente']."',
'".$myrow1['fechaAccidente']."',
'".$myrow1['horaAccidente']."',
'".$myrow1['lugarAccidente']."',
'".$myrow1['llegoHospital']."',
'".$myrow1['ministerio']."',
'".$myrow1['motivoConsulta']."',
'".$myrow1['alergiaT']."',
'".$myrow1['alergiaP']."',
'".$myrow1['alergiaR']."',
'".$myrow1['alergiaPA']."',
'".$myrow1['tiposAlergias']."',
'".$myrow1['peso']."',
'".$myrow1['dx']."',
'".$myrow1['empleado']."','".$myrow1['expediente']."','".$fechaSol."','".$despliegaEC." ','D','".$estudiante."','".$myrow1['descuento']."','".$myrow1['cortesia']."',
    '".$myrow1['activaBeneficencia']."','".$myrow1['porcentaje']."','".$myrow1['tipoBeneficencia']."','".$myrow1['llenadoEspecial']."','".$usuario."','".$myrow333['NS']."'
...
descripcionClientePrincipal,descripcionMedico,primeraVez,statusDescuento,horaCargo
)
values 
('".$myrow1['numeroE']."',
'".$myrow1['nCuenta']."',
...
if($usuario=='omorales'){
    ...
    if($myrow['precioVenta']<1 and $myrow1['cargoModificable']!='si'){
...
if($myrow13ab['afectaExistencias']!='si'){
...
$cantidadReal=$cantidadReal->cantidadReal($almacen,$priceLevel,$codigo,$entidad,$keyPA,$basedatos);
//**********************************************************************************   
}else{
  $priceLevel=$myrow1['precioVenta'];    
}
