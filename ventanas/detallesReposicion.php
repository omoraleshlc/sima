...
$pdf->SetXY(2,25);
$pdf->Cell(0,0,"VENTAS BOTIQUINES",0,0,M);
$pdf->SetX(1);
...
cargosCuentaPaciente.almacenDestino!='".$cendis."'
  and
cargosCuentaPaciente.almacenDestino!='".$farmacia."'  
...
while($myrowa = mysql_fetch_array($resulta)){
	...
	$checaModuloScript2a= "Select almacenPadre from almacenes WHERE entidad='".$_GET['entidad']."' 
	and 
...
entidad='".$_GET['entidad']."'
and
almacen='".$resulScripModulo2a['almacenPadre']."'  ";
$result40=mysql_db_query($basedatos,$sSQL40);
$myrow40 = mysql_fetch_array($result40);
