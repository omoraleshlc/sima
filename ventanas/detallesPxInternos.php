...
$pdf->SetXY(2,5);
$pdf->Cell(0,0,'REPORTE VENTAS PX. INTERNOS',0,0,M);
$pdf->SetX(1);
...
$pdf->SetX(2);
$pdf->Cell(0,0,"EFECTIVO INTERNOS",0,0,M);
$pdf->SetX(1); 
...
entidad='".$_GET['entidad']."'
and
gpoProducto='".$myrow1a['gpoProducto']."'
and
folioVenta='".$myrow['precioVenta']."'
and
naturaleza='C'
...
$pdf->Ln(20); //salto de linea
$pdf->SetX(2);
$pdf->Cell(0,0,"CXC INTERNOS",0,0,M);
$pdf->SetX(1); 
