...
if($_POST['incapacidad'] and $_POST['enviar'] ){
...
echo '<script language="JavaScript" type="text/javascript">
  ...
  window.alert( "Incapacidad Agregada ");
...
<form id="form1" name="citas" method="post" >
  <p>&nbsp;</p>
  ...
  <table width="440" border="0" align="center"  >
    ...
    <label>
          <textarea name="incapacidad" cols="80" rows="4" wrap="virtual" ><?php echo $myrow10['incapacidad'];?></textarea>
          </label>
