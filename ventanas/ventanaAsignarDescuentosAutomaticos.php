...
if($porcentaje[$i]==0 or $porcentaje[$i]==NULL){
...
<h1 align="center" >Descuentos Automaticos </h1>
<p align="center" ><?php echo '<blink>'.$leyenda.'</blink>';?></p>
<form id="form1" name="form1" method="post" action="">
  <p align="center">&nbsp;</p>
  
  <table width="497" class="table table-striped">
      <tr>
        <th width="60"  scope="col"><div align="left" >Cod. GP</div></th>
        <th width="281"  scope="col"><div align="left" >Descripci&oacute;n de Productos </div></th>
        <th width="69"  scope="col" ><div align="left">Tipo Px </div></th>
        <th width="69"  scope="col"><div align="center">%</div></th>
      </tr>
      <tr>
