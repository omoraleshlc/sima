...
//$fecha1=$_GET['fecha'];
$pdf->SetY(10);
$pdf->Cell(0,0,'Orden: '.$_GET['nOrden'],0,0,R);
...
$sSQL2= "Select sum(cantidad) as c From movSolicitudes WHERE entidad='".$_GET['entidad']."'  and
    numSolicitud='".$_GET['numSolicitud']."'
and
codigo='".$myrow['codigo']."'
";
...
$pdf->SetX('15');
$pdf->Cell(0,0,$myrow['descripcion'],0,0,M);
...
//
$pdf->SetX('140');
$pdf->Cell(0,0,$myrow['status'],0,0,M);
