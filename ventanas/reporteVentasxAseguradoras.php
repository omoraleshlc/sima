...
(fechaCierre>='".$_GET['fechaInicial']."' and fechaCierre<='".$_GET['fechaFinal']."')
    and
clientePrincipal='".$_GET['clientePrincipal']."'
and
...
$pdf->SetX('30');
$pdf->Cell(0,0,'TOTALES EXTERNOS',0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'SUBTOTAL $'.number_format($totalExternos[0],2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'IVA $'.number_format($totalIVAExternos[0],2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'TOTAL $'.number_format($totalExternos[0]+$totalIVAExternos[0],2),0,0,M);
...
$pdf->SetX('30');
$pdf->Cell(0,0,'TOTALES INTERNOS',0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'SUBTOTAL $'.number_format( $ventasInternos[0],2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'IVA $'.number_format( $ivaInternos[0],2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'TOTAL $'.number_format($ventasInternos[0]+$ivaInternos[0],2),0,0,M);
...
$pdf->SetX('30');
$pdf->Cell(0,0,'TOTALES VENTAS VARIAS',0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'SUBTOTAL $'.number_format( $abonosVDE,2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'IVA $'.number_format( $totalIVAVD[0],2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'TOTAL $'.number_format($abonosVDE+$totalIVAVD[0],2),0,0,M);
...
$pdf->SetX('30');
$pdf->Cell(0,0,'TOTAL GLOBAL',0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'SUBTOTAL $'.number_format(($totalExternos[0])+($ventasInternos[0])+($abonosVDE),2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'IVA $'.number_format( ($totalIVAExternos[0])+($ivaInternos[0])+($totalIVAVD[0]),2),0,0,M);
$pdf->Ln(4); //salto de linea
$pdf->SetX('80');
$pdf->Cell(0,0,'TOTAL $'.number_format(((($totalExternos[0])+($ventasInternos[0])+($abonosVDE))+($totalIVAExternos[0])+($ivaInternos[0])+($totalIVAVD[0])),2),0,0,M);
