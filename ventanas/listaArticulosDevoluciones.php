...
echo '<div class="success">Articulos Actualizados</div>';
...
$agregaSaldo = "INSERT INTO OC ( id_requisicion,id_almacen,usuario,fecha,hora,status,prioridad,id_proveedor,
    entidad,numFactura,keyPA,cantidadParticular,cantidadAseguradora,cantidad,descripcionArticulo,naturaleza,statusDevolucion

) values (

'".$_GET['req']."','".$_GET['departamento']."','".$usuario."','".$fecha1."','".$hora1."','request',
'".$_POST['prioridad']."','".$_GET['proveedor']."','".$entidad."','".$_GET['id_factura']."','".$_POST['keyPA']."' ,'0.00','0.00','0' ,'".$myrow12['descripcion']."','C','si' )";
...
<?php if($bandera>0){?>
    ...
    <div align="center">
      ...
      <br></br>
       ...
       <input name="send" type="submit" id="update" value="Enviar Solicitud" />
