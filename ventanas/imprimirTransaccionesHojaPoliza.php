...
$pdf->SetX('2');
$pdf->Cell(0,0,'['.$myrowa['descripcionAlmacen'].']',0,0,M);
...
$sSQLd= "SELECT sum((precioVenta*cantidad)+(iva*cantidad)) as debe FROM polizas
WHERE
entidad='".$_GET['entidad']."'
and
fechaCierre='".$fecha1."'
...
$sSQLh= "SELECT sum((precioVenta*cantidad)+(iva*cantidad)) as haber FROM polizas
WHERE
entidad='".$_GET['entidad']."'
and
fechaCierre='".$fecha1."'
