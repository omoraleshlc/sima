...
$pdf->SetXY(2,25);
$pdf->Cell(0,0,"REGISTRO DE CONSIGNACIONES COMPRAS",0,0,M);
$pdf->SetX(1);
...
$pdf->SetX('2');
$pdf->Cell(0,0,$myrow['numFactura'],0,0,M);	

$pdf->SetX('20');
$pdf->Cell(0,0,$resulScripModulo2a['descripcionProveedor'],0,0,M);	
...
$pdf->SetX('150');
$pdf->Cell(0,0,'$'.number_format($myrowdee['pV'],2),0,0,M);
