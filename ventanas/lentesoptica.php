...
$myrow1 = mysql_fetch_array($result1);
 ...
 $sSQL4= "Select * From cargosCuentaPaciente where 
keyCAP='".$_GET['keyCAP']."'
                                    ...
                                    '".$_POST['prisma2I']."',
                                        '".$_POST['prismaDireccion2I']."',
                                            '".$_GET['keyClientesInternos']."',
                                                '".$myrow4['codProcedimiento']."','".$entidad."'
...
<?php echo 'PACIENTE: '.$_GET['paciente'];?></p>
  ...
  <tr>
    <td colspan="14" align="center"  >
        <?php echo $myrow4['descripcionArticulo'];?>
    </td>
 ...
 <?php if($myrow1['tipoArmazon']=='Ranurado'){echo 'selected=""';}?>
  ...
  <tr>
    ...
    <br></br>
    <div align="center">	
        <input type="submit" name="send"      value="Guardar Cambios"></input>
