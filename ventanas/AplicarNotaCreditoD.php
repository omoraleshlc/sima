...
if($myrow3['tipoTransaccion']=='APNC'){
...
if($_POST['observaciones']!=NULL){
    $describe='Devolucion de Pago de una Nota de Credito';
}
...
'".$_POST['almacenDestino1']."','".$myrow3['keyClientesInternos']."','pagado','".$myrow3['observaciones']."','sinAplicar','".$hora1."',
'".$fecha1."','".$_POST['codigoTarjeta']."','".$_POST['ultimosDigitos']."','".$_POST['codigoAutorizacion']."',
    '".$_POST['numeroCheque']."','".$_POST['bancoTransferencia']."',
'".$_POST['bancoCheque']."','".$_POST['numeroTransferencia']."','si','standby','".$myrow3['seguro']."',
...
'".$t."','',
    ...
    '".$describe."','".$myrow38['descripcionGP']."',
        '".$entidad."','pagado','".$fecha1."','".$hora1."','',
            '".$codigoTT."','C','".$myrow3['seguro']."',
                '".$myrow3['seguro']."','".$_POST['keyCAP']."',
...
<br />
  <form name="form1" method="post"   >
    ...
    <tr>
      ...
      <th colspan="3"   scope="col"><p align="center">Devolucion de Nota de Credito</p></th>
    </tr>
