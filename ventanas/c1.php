...
$sSQL1= "Select * From relacionSWEquipos WHERE entidad='".$entidad."'
    and
...
$agrega = "INSERT INTO relacionSWEquipos (
...
if(!$_POST['update'] and !$_POST['ADDSW'] and $_GET['keySW']>0 and $_GET['del']=='si'){
 ...
 $q = "DELETE FROM relacionSWEquipos
