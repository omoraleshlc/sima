...
$pdf->SetXY(4,25);
$pdf->Cell(0,0,"BENEFICENCIAS APLICADAS POR FOLIO DE VENTA",0,0,M);
$pdf->SetX(1); 
...
$pdf->SetXY(25,30);
$pdf->Cell(0,0,'Nombre del paciente',0,0,M);
...
//almacen='".$myrow['almacen']."'  ";
  ...
  $sSQL1b1= "SELECT paciente FROM clientesInternos
WHERE
entidad='".$_GET['entidad']."'
and
...
$pdf->SetX('29');
$pdf->Cell(0,0,$myrow1b1['paciente'],0,0,M);
