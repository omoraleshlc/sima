...
while($myrow5= mysql_fetch_array($result5)){
 ...
 $importe=$myrow5['cantidadParticular'];
 $iva=$myrow5['ivaParticular'];
 }else{ 
 $importe=($myrow5['cantidadParticular']*$percent);
 $iva=($myrow5['ivaParticular']*$percent);
 }
...
<h2>
  ...
  <a href="javascript:ventanaSecundaria5('ventanaAjustarExtensiones.php?entidad=<?php echo $entidad;?>&extension=<?php echo $_POST['extension'];?>&folioVenta=<?php echo $_GET['folioVenta'];?>');"></a></p>
   ...
   $sSQL= "Select * From facturaGrupos where
      entidad='".$entidad."' and folioVenta='".$_GET['folioVenta']."' and random='".$_GET['random']."'
...
<a href="editExtensiones.php?random=<?php echo $_GET['random'];?>&gpoProducto=<?php echo $myrow['gpoProducto'];?>&folioVenta=<?php echo $_GET['folioVenta'];?>&extension=<?php echo $_POST['extension'];?>&porcentaje=<?php echo $_POST['porcentaje'];?>&off=si&keyMOV=<?php echo $_GET['keyMOV'];?>">
Quitar Grupo
</a>
                <?php }else { ?>
                    <a href="editExtensiones.php?random=<?php echo $_GET['random'];?>&gpoProducto=<?php echo $myrow['gpoProducto'];?>&folioVenta=<?php echo $_GET['folioVenta'];?>&extension=<?php echo $_POST['extension'];?>&porcentaje=<?php echo $_POST['porcentaje'];?>&add=si&keyMOV=<?php echo $_GET['keyMOV'];?>">
add Grupo
</a>
<?php 
                }
