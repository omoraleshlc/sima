...
$pdf->SetXY(2,5);
$pdf->Cell(0,0,'HOJA DE AUDITORIA (POLIZA DE INGRESOS MENSUALES)',0,0,M);
$pdf->SetX(1);
...
$fecha1=$_GET['fecha'];
$pdf->SetY(10);
$pdf->Cell(0,0,'Fecha Impresion: '. cambia_a_normal($date),0,0,R);
...
$pdf->SetXY(2,16);
$pdf->Cell(0,0,'FechaInicial: '.$_GET['fechaInicial'].', FechaFinal: '.$_GET['fechaFinal'],0,0,M);
