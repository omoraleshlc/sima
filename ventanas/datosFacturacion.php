...
prefijoEfectivo,prefijoCxC,digitosFactura     
...
'".$_POST['calle1']."',
    '".$_POST['prefijoEfectivo']."','".$_POST['prefijoCxC']."','".$_POST['digitosFactura']."'
)
    ";
mysql_db_query($basedatos,$agrega);
echo mysql_error();
...
?>
         ...
         <tr>
         <div class="titulos">Exclusivo Facturacion</div>    
         </tr>
       ...
       <td  ><div align="left" >
         ...
         <input type="prefijoEfectivo" name="prefijoEfectivo" size="5" value="<?php

		 echo $myrow2['prefijoEfectivo'];
		 ?>" />
       ...
       <td  ><div align="left" >
         ...
         <input type="prefijoCxC" name="prefijoCxC" size="5" value="<?php

		 echo $myrow2['prefijoCxC'];
		 ?>" />
       ...
       <td  >Digitos de Factura</td>
       <td  ><div align="left" >
         
         <input type="digitosFactura" name="digitosFactura" size="5" value="<?php

		 echo $myrow2['digitosFactura'];
		 ?>" />
          </div></td>
     </tr>          
