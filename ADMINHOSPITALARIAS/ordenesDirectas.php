...
<form id="form2" name="form2" method="post" action="">
  ...
  <table width="684" class="table-forma">
    <tr>
      ...
      <td width="574"   scope="col"><div align="left">
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
    ...
    <tr>
      ...
      <td  scope="col">&nbsp;</td>
      <td  scope="col"><div align="left"><div align="left"><input name="buscar" type="submit"  id="buscar" value="buscar" />
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="645" class="table table-striped">
    <tr>
      ...
      <th width="32"  scope="col"><span >UM</span></th>
      <th width="27"  scope="col"><span >Existe</span></th>
      <th width="36"  scope="col"><span >M&aacute;ximo</span></th>
      <th width="36"  scope="col"><span >Reorden</span></th>

      <th width="41"  scope="col"><span >Cantidad</span></th>
      <th width="32"  scope="col"><span >Solicita</span></th>
      <th width="27"  scope="col"><span >Status</span></th>
    </tr>
    <tr>
<?php	
...
<div align="center"><strong>
  ...
  <p align="center">
    ...
    <input name="solicitar" type="submit"  id="solicitar" value="Solicitar/Actualizar" />
    </label>
    <label></label>
