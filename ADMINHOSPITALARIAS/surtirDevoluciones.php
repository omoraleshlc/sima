...
<body>
 ...
 <form id="form1" name="form1" method="post" >
  <h1 align="center">SURTIR DEVOLUCIONES</h1>
...
<?php if($myrow['statusCargo']!='cargado'){         ?>
          <a href="#"  onclick="javascript:ventanaSecundaria('/sima/cargos/despliegaSolicitudesDirectas.php?departamentoSolicitante=<?php echo $myrow['descripcionAlmacen'];?>&numeroE=<?php echo $myrow['numeroE']; ?>
		&amp;nCuenta=<?php echo $myrow['nCuenta']; ?>&amp;almacen=<?php echo $bali; ?>&amp;seguro=<?php echo $_POST['seguro']; ?>&amp;almacenDestino=<?php echo $myrow['almacenDestino']; ?>&folioVenta=<?php echo $myrow['folioVenta'];?>&paciente=<?php echo $myrow8a['paciente'];?>&usuario=<?php echo $myrow['usuario'];?>&numSolicitud=<?php echo $myrow['numSolicitud'];?>&usuarioSolicitante=<?php echo $myrow['usuario'];?>&horaSolicitud=<?php echo $myrow['horaSolicitud'];?>&fechaSolicitud=<?php echo $myrow['fecha1'];?>')">
         Cargar
         </a>         
<?php }else{
         echo '---';
 ...
 <td ><?php echo $myrow['statusCargo']?></td>     
