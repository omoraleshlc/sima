...
keyPA = '".$_GET['keyPA']."' and nivel1>'".$nivel1."'";
  ...
  ?>
    ...
    <tr>
      <td width="100" height="26" bgcolor="#CCCCCC" class="normalmid"> Particular</td>
      <td width="151" bgcolor="#CCCCCC"><input name="particular" type="text" class="camposmid" value="" size="10" /></td>
    </tr>
    <tr>
      <td height="27" bgcolor="#CCCCCC" class="normalmid"> Aseguradora</td>
      <td bgcolor="#CCCCCC"><input name="aseguradora" type="text" class="camposmid"  value="" size="10" /></td>
    </tr>
    <tr>
