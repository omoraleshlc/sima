...
<p>&nbsp;</p>
  ...
  <table width="600" border="0" cellspacing="0" cellpadding="3" align="center" class="normalmid">
    ...
    <td width="10" class="none" align="center">Anaquel</td>
 
   
      <td width="10" class="none" align="center">Costo</td>
      <td width="10" class="none" align="center">Editar</td>
    </tr>
<?php	
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
        <select name="anaquel[]" class="normal" />        
    
  <option
      <?php  if($_POST['anaquel']=='*'){echo 'selected=""';}?>
      
      value="" >Ninguno</option>
        ...
        <option 
		<?php 
 if($myrow1['anaquel'] ==$resCombo['anaquel'] ){ 
        ...
        <input name="costo[]" type="text" class="normal"  value="
<?php 
	  if($myrow12['costo']>0){
	  echo $myrow12['costo'];
	  } else {
...
<p align="center">&nbsp;</p>
  ...
  <p align="center">
    ...
    value="Ajustar Anaquel/Costo" <?php if($a<1){	echo 'disabled="disabled"';
	}
	?> />
