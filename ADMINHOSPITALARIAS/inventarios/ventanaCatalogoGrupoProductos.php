    ...
    '".$_POST['afectaExistencias']."','".$_POST['medicos']."','".$_POST['rutaModifica']."','".$_POST['porcentajeParticular']."',
        '".$_POST['porcentajeAseguradora']."','".$_POST['stock']."','".$_POST['precioPorAlmacen']."',
            '".$_POST['tipoReporte']."','".$_POST['separadoAlmacen']."','".$_POST['honorarios']."' ,
                '".$_POST['medicamento']."','".$_POST['maximo']."','".$_POST['minimo']."','".$_POST['reorden']."'
                )";
...
?>
    ...
    <tr>
      <td class="style12">Es un Medicamento</td>
      <td class="style12"><input name="medicamento" type="checkbox" id="cargosDirectos" value="si" <?php
      ...
      <tr>
      <td class="style12">Maximo(Solo Medicamentos)</td>
      <td class="style12"><input name="maximo" type="text" size="5" value="<?php echo $myrow2['maximo'];?>" /></td>
      </tr>


      <tr>
      <td class="style12">Minimo(Solo Medicamentos)</td>
      <td class="style12"><input name="minimo" type="text" size="5"  value="<?php echo $myrow2['minimo'];?>" /></td>
      </tr>


      <tr>
      <td class="style12">Reorden(Solo Medicamentos)</td>
      <td class="style12"><input name="reorden" type="text" size="5" value="<?php echo $myrow2['reorden'];?>" /></td>
      </tr>
    ...
    <tr>
      <td class="style12">Precio x Almacen </td>
      <td class="style12"><input name="precioPorAlmacen" type="checkbox" id="precioPorAlmacen" value="si" <?php 
