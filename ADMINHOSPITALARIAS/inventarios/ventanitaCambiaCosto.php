...
codigo = '".$_GET['codigo']."'   order by keyC DESC
  ...
  ?>
    ...
    <tr>
      ...
      <td width="163">
      <input name="costo" type="text" class="normal" id="costo" value="<?php echo $myrow5['costo'];?>"></input>
      </td>
    </tr>
      ...
      <td width="163">
      <input name="precioSugerido" type="text" class="normal" id="costo" value="<?php echo $myrow5['precioSugerido'];?>"></input>
      </td>
    </tr>
