...
<form id="form2" name="form2" method="post" action="">
  ...
  <table width="726" border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
      ...
      <th width="54" bgcolor="#CCCCCC" class="style7" scope="col"><div align="left"><span class="Estilo24">Art&iacute;culo </span></div></th>
      <th width="625" bgcolor="#CCCCCC" class="style7" scope="col"><div align="left"><span class="Estilo24">
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
  ...
  <img src="../../imagenes/bordestablas/borde2.png" width="726" height="24" />
<p align="center">&nbsp;</p>
</form>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="726" border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
      ...
      <th width="172" bgcolor="#FFFF00" scope="col">Descripci&oacute;n</th>
      <th width="48" bgcolor="#FFFF00" scope="col">UM</th>
      <th width="53" bgcolor="#FFFF00" scope="col">Existe</th>
      <th width="69" bgcolor="#FFFF00" scope="col">M&aacute;ximo</th>
      <th width="69" bgcolor="#FFFF00" scope="col">Reorden</th>

      <th width="75" bgcolor="#FFFF00" scope="col">Cantidad</th>
      <th width="58" bgcolor="#FFFF00" scope="col">Solicita</th>
      <th width="95" bgcolor="#FFFF00" scope="col">Status</th>
    </tr>
    <tr>
<?php	
