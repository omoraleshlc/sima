...
<form id="form1" name="form1" method="post" action="">
  <table width="404" border="1" align="center">
    <tr>
      ...
      <th width="317" bgcolor="#660066" scope="col"><span class="style11">Descripci&oacute;n de la Pieza </span></th>
    </tr>
    <tr>
      <?php 

	 
$sSQL11= "Select distinct * From clientes ORDER BY nomCliente ASC ";
