...
<img src="<?php echo $myrow['ruta']; ?>"
 ...
 <?php } ?>
  ...
  <table width="536" border="0" align="center" cellpadding="0" cellspacing="0" class="style12">
    ...
    <tr>
      <th bgcolor="#CCCCCC" class="none" scope="col">&nbsp;</th>
      <th bgcolor="#CCCCCC" class="none" scope="col"><div align="left">C&oacute;digo CB </div></th>
      <th bgcolor="#CCCCCC" class="style12" scope="col"><div align="left">
        <input name="codigoCB" type="text" class="Estilo24" id="codigoCB" value="<?php echo $_POST['codigoCB']; ?>" size="60" />
      </div></th>
    </tr>
    <tr>
      <th width="10" height="83" bgcolor="#CCCCCC" class="style12" scope="col">&nbsp;</th>
      <th width="148" bgcolor="#CCCCCC" class="none" scope="col"><div align="left">Descripci&oacute;n:</div></th>
      <th width="404" bgcolor="#CCCCCC" class="style12" scope="col"><label>
        <div align="left">
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC" class="style12">Subir im&aacute;gen: </td>
    ...
    <tr>
      <td height="33" colspan="3" bgcolor="#CCCCCC"><label>
