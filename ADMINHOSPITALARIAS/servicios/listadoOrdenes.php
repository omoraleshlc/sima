...
<form id="form1" name="form1" method="post" action="">
  <table width="702" border="1" align="center">
    <tr>
      ...
      <th width="55" bgcolor="#660066" scope="col"><span class="style11">Almac&eacute;n</span></th>
      ...
      <th width="164" bgcolor="#660066" scope="col"><span class="style11">Proveedor</span></th>
    </tr>
    <tr>
<?php	
...
?>
      ...
      <td bgcolor="<?php echo $color?>" class="style12"><span class="style7"><?php echo $myrow18['id_almacen']; ?></span></td>
