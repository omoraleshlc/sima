...
<form id="form2" name="form2" method="post" action="">
  <table width="684" border="0" align="center">
    <tr>
      <th width="22" bgcolor="#FFCCFF" scope="col">&nbsp;</th>
      <th width="66" bgcolor="#FFCCFF" class="style7" scope="col"><div align="left">Proveedor</div></th>
      <th width="574" bgcolor="#FFCCFF" class="style7" scope="col"><div align="left">
    ...
    <tr>
      <th scope="col">&nbsp;</th>
      <th class="style7" scope="col"><div align="left"><em>OC Activas</em></div></th>
      <th class="style7" scope="col"><div align="left"><em>
        <?php 
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
    ...
    <tr>
      <th height="23" bgcolor="#FFCCFF" scope="col">&nbsp;</th>
      <th bgcolor="#FFCCFF" scope="col">&nbsp;</th>
      <th bgcolor="#FFCCFF" scope="col"><div align="left"><div align="left"><input name="buscar" type="submit" class="Estilo24" id="buscar" value="buscar" />
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="645" border="0" align="center">
    <tr>
      ...
      <th width="322" bgcolor="#660066" scope="col"><span class="style11">Descripci&oacute;n</span></th>
      <th width="32" bgcolor="#660066" scope="col"><span class="style11">UM</span></th>
