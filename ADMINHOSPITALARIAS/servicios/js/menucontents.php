...
anylinkmenu1.items=[
	["Cambiar Descripción", "javascript:ventanaSecundaria6('ventanaCambiaDescripcion.php?keyPA=<?php echo $myrow['keyPA'];?>&amp;seguro=<?php echo $_GET['seguro']; ?>&amp;inactiva=<?php echo 'inactiva'; ?>&amp;tipoAlmacen=<?php echo $_POST['tipoAlmacen']; ?>&amp;codigo=<?php echo $C; ?>&amp;criterio=<?php echo $_GET["criterio"];?>')" class="menuanchorclass" rel="anylinkmenu1"],
