...
CONTENT="30"> 
<body>
<h1 align="center">Recepci&oacute;n de Ordenes de Compra </h1>
<p>&nbsp;</p>
<form id="form1" name="form1" method="post" action="oc.php">
  <table width="325" border="1" align="center">
    <tr>
      <th width="90" bgcolor="#660066" scope="col"><span class="style11"># OC </span></th>
