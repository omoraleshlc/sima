...
<body>
    <br><br>
 <h1 align="center" >Proceso de Comparacion de Inventarios</h1>
 <br>
...
<?php if( $myrow['status']=='open'){?>       
 <a href="#" onClick="javascript:ventanaSecundaria('../ventanas/ventanaFinalInventarios.php?keylistas=<?php echo $myrow['keylistas']; ?>&nCuenta=<?php echo $myrow['nCuenta']; ?>&almacen=<?php echo $bali; ?>&seguro=<?php echo $_POST['seguro']; ?>&tipoPaciente=<?php echo "interno"; ?>&keyClientesInternos=<?php echo $myrow['keyClientesInternos'];?>')">
 Cargar           
 </a>
<?php }else{ echo '---';}?>          
