...
<form id="form10" name="form10" method="post" >
  ...
  <table width="500" class="table-forma">
   ...
   <input name="button" type="image" id="lanzador1" src="/sima/imagenes/btns/fecha.png" />
          ...
          <tr><td width="250" height="40" ><label>
       
              Descripcion Articulo
   <input name="descripcion" type="text"   size="60" value="<?php echo $_POST['descripcion']; ?>" />
      </label></td>
...
<tr >
      ...
      <th width="100"  ><div align="left">Descripcion</div></th>
       <th width="20" ><div align="left">Sustancia</div></th>
        <th width="10" ><div align="left">Grupo</div></th>
...
?>
      ...
      <td  >
          <div align="left">
<a href="javascript:ventanaSecundaria5('../ventanas/verkardex.php?keyPA=<?php echo $myrow['keyPA']; ?>&descripcion=<?php echo ltrim($myrow['descripcion']); ?>
...
&fechaCreacion=<?php echo $myrow['fecha'];?>&fechaActualizacion=<?php echo $myrow['fechaActualizacion'];?>&usuarioCreacion=<?php echo $myrow['usuario'];?>');"   />              
          <?php echo $myrow5['descripcion'];
          if($myrow['cbarra']>0){
          echo  '<br>';
          echo $myrow['cbarra'];    
          }
          
          if(!$myrow5['codigo'] || $myrow5['activo']=='I'){
              echo '<br>';
              echo '<div class="error">ARTICULO ELIMINADO o DESACTIVADO!</div>';
          }
          ?>
