...
'width:'+to_em(o.hdingwidth, o)+'em; /*This will be the menu body width.  This'+(o.menupos!='top'? ' (plus #'+o.id+'bar width for left and righ menus)' : '')+' and 4 times the border width should also be the menu table\'s approximate width*/\n'+
...
if(!o.bartext) {o.bartext="Menú Principal"};
