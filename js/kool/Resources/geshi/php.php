 ...
 * CVS Revision Version: $Revision: 1.14.2.1 $
 * Date Started: 2004/06/20
 * Last Modified: $Date: 2006/06/21 10:38:15 $
 *
...
$language_data = array (
	...
	'KEYWORDS' => array(
		...
		3 => array(
			...
			'mysql_fetch_row','mysql_fetch_object','mysql_fetch_lengths','mysql_fetch_field','mysql_fetch_assoc','pg_fetch_array',
			'mysql_escape_string','mysql_error','mysql_errno','mysql_dropdb','mysql_drop_db','mysql_dbname',
			'pg_query','mysql_db_name','mysql_data_seek','mysql_createdb','mysql_create_db','mysql_connect',
