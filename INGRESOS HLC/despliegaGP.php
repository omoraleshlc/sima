...
echo $nombrePaciente1;
    ...
    <table width="400" class="table table-striped">
       <tr >
        <th width="100"   scope="col"><div align="left"><span >Almacen</span></div></th>
        <th width="41"   scope="col"><div align="left"><span >GPO</span></div></th>
        <th width="52"   scope="col"><div align="left"><span >F. Inicial</span></div></th>
        <th width="51"   scope="col"><div align="left"><span >F. Final </span></div></th>
        <th width="39"   scope="col"><div align="left"><span >Elimina</span></div></th>
      </tr>
      <tr>
<?php	
$sSQL= "SELECT 
...
?>
	 ...
	 // echo $myrow2['existencias'];
      ...
      <?php echo cambia_a_normal($myrow['fechaFinal']); ?>
        ...
        <td  ><input name="elimina[]" type="checkbox" id="elimina[]" value="<?php echo $myrow['keyConvenios']; ?>" /></td>
      </tr>
      <?php  
	  $bandera+='1';
	  }  //cierra while?>
