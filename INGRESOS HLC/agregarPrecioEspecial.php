...
<body>
  ...
  <p align="center" >Precios Especiales</p>
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
        <select name="almacenDestino1"  id="almacenDestino" />
...
$result1=mysql_db_query($basedatos,$sSQL1); 
      ...
      <tr>
        <td height="22" >&nbsp;</td>
        <td  >Incluir Referidos</td>
        <td ><input name="incluirReferidos" type="checkbox" id="incluirReferidos" value="si" /></td>
      </tr>
      <tr>
        <td height="25" >&nbsp;</td>
        <td  >Porcentaje</td>
        <td ><input name="costo" type="text"  id="costo" size="4" maxlength="10"
		 value=""	/>
<span >Qu&eacute; porcentaje deseas agregar?</span></td>
      </tr>
      <tr>
        <td height="34" >&nbsp;</td>
        <td  >Fechas<br /></td>
      ...
      <tr>
        <td colspan="3"  align="center"><input name="actualizar" type="submit"  id="actualizar" value="Crear Nuevo Precio Especial" />
