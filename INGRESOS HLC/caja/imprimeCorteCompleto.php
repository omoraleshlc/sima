...
where
codigoCaja='".$_GET['codigoCaja']."' and numCorte='".$_GET['numCorte']."' 
and
naturaleza='C'
...
$prefijo=0;
}else if($myrow['tipoPaciente']=='interno'){
$prefijo=1;
}
...
$pdf->SetX('15');
$pdf->Cell(0,0,$myrow40a['descripcion'],0,0,L);
