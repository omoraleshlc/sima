...
if($_GET['transaccion']!='' and $_GET['aplicarPago'] ){
...
$q4 = "UPDATE clientesInternos set statusDeposito='pagado',usuario='".$usuario."',fecha1='".$fecha1."',numRecibo='".$RECIBO."',numCorte='".$numCorte."',codigoCaja='".$myrowC['keyCatC']."'
WHERE keyClientesInternos='".$numeroCuenta."'";
mysql_db_query($basedatos,$q4);
echo mysql_error();
}
...
if(($_GET['tipoPago']=='Cuentas por Cobrar')  or ($coa!=NULL)){
...
statusImpresion,numRecibo,folioVenta,codigoCaja,statusCaja,telefono,clientePrincipal,precioVenta,bancoCheque,numeroCheque,random,codigoAutorizacion,ultimosDigitos,bancoTC,descripcionArticulo,tipoCuenta) 
values 
...
'".$_GET['cantidadRecibida']."','".$_GET['bancoCheque']."','".$_GET['numeroCheque']."','".$_GET['random']."','".$_GET['codigoAutTC']."','".$_GET['ultimosDigitos']."','".$_GET['bancoTC']."' ,'".$describe."','D'  )";
...
('".$numeroE."','".$nCuenta."','transaccion',
'".$usuario."','".$fecha1."','".$dia."','1','".$_GET['tt']."','operacionCaja',
'".$hora1."','P','".$ID_EJERCICIOM."','pagado','".$ALMACEN."','".$usuario."',
'".$seguro."','".$statusTraslado."','".$myrow341['tipoCliente']."','".$myrow3['tipoPaciente']."',
'".$cantidadParticular."','".$cantidadAseguradora."','".$numCorte."','".$entidad."','".$_GET['tipoPago']."','standby',
'".$_GET['tipoPago']."','".$ALMACEN."','".$numeroCuenta."','standby','cargado','standby','".$RECIBO."','".$myrow3['folioVenta']."','".$myrowC['keyCatC']."','pagado','".$_GET['telefono']."','".$myrow455['clientePrincipal']."',
'".$_GET['cantidadRecibida']."','".$_GET['bancoCheque']."','".$_GET['numeroCheque']."','".$_GET['random']."','".$_GET['codigoAutTC']."','".$_GET['ultimosDigitos']."','".$_GET['bancoTC']."' ,'".$describe."','H')";
mysql_db_query($basedatos,$agrega);
echo mysql_error();
//***********************************************
...
'".$_GET['bancoTC']."','".$describe."','".$describe."','D')";
mysql_db_query($basedatos,$agrega);
echo mysql_error();
...
,'".$_GET['tipoPago']."','".$ALMACEN."','".$numeroCuenta."','standby','cargado','standby','".$RECIBO."','".$myrow3['folioVenta']."','".$myrowC['keyCatC']."','pagado','".$_GET['telefono']."',
'".$myrow455['clientePrincipal']."','".$_GET['cantidadRecibida']."','".$_GET['bancoCheque']."','".$_GET['numeroCheque']."','".$_GET['random']."','".$_GET['codigoAutTC']."','".$_GET['ultimosDigitos']."',
'".$_GET['bancoTC']."','".$describe."','".$describe."','H')";
mysql_db_query($basedatos,$agrega);
echo mysql_error();
//*************************************************
...
numeroE,nCuenta,status,usuario,fecha1,dia,cantidad,tipoTransaccion,codProcedimiento,hora1,
naturaleza,ejercicio,statusDeposito,almacen,usuarioTraslado,seguro,
statusTraslado,tipoCliente,tipoPaciente,cantidadParticular,cantidadAseguradora,numCorte,entidad,tipoCobro,statusAuditoria,tipoPago,almacenDestino,keyClientesInternos,statusFactura,statusCargo,statusImpresion,numRecibo,folioVenta,codigoCaja,statusCaja,telefono,clientePrincipal,precioVenta,bancoCheque,numeroCheque,random,codigoAutorizacion,ultimosDigitos,bancoTC,descripcionArticulo,tipoCuenta) 
values 
('".$numeroE."','".$nCuenta."','transaccion',
'".$usuario."','".$fecha1."','".$dia."','1','".$_GET['tt']."','operacionCaja',
'".$hora1."','".$naturaleza."','".$ID_EJERCICIOM."','pagado','".$ALMACEN."','".$usuario."',
...
<?php if(($myrow3 ['tipoPaciente']=='interno' or $myrow3['tipoPaciente']=='urgencias') or $_GET['tipoTransaccion']=='coaseguro' or $_GET['tipoVenta']=='interno' or $_GET['abono']=='si' or $_GET['devolucion']=='si'){ ?>
		...
		<?php if($_GET['modoPago']=='efectivo'){ ?>
            ...
            <select name="tipoPago" class="style20" id="tipoPago" onChange="javascript:form.submit();" <?php if($_GET['tipoCliente']!=NULL) //echo 'disabled=""';?>>
             <option value="">Escoje...</option>
			    ...
			    <?php }else if($_GET['modoPago']=='devolucion'){  ?>
            
            <select name="tipoPago" class="style20" id="tipoPago" onChange="javascript:form.submit();" >
...
<input name="transaccion" type="hidden" class="style7" id="transaccion" value="<?php echo $_GET['transaccion'];?>" />
<?php } else { ?>
<script>
...
<?php //ESTA ES LA CANTIDAD 
 if($_GET['tipoPago']=='Nomina'){ //opciones
...
if($_GET['tipoPago'] and $_GET['tipoTransaccion'] and $transaccion) {  ?>
...
<?php } ?>
		...
		<input name="numCoaseguro" type="hidden" class="style7" id="precioVenta" value="<?php echo $_GET['numCoaseguro'];?>"/>
