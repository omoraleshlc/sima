...
$sSQL= "SELECT * from clientesInternos,cargosCuentaPaciente
where

cargosCuentaPaciente.entidad='".$entidad."'
and
clientesInternos.status='devolucion'
and
...
order by 
cargosCuentaPaciente.folioVenta ASC
 ";
...
$cos="$".number_format($myrow['precioVenta']*$myrow['cantidad'],2);
...
//**********************************
$sSQL1= "Select descripcion From almacenes where almacen='".$myrow['almacenDestino']."'";
$result1=mysql_db_query($basedatos,$sSQL1);
$myrow1 = mysql_fetch_array($result1);
//*********************************

$pdf->SetX('15');
$pdf->Cell(0,0,$myrow1['descripcion'],0,0,L);
