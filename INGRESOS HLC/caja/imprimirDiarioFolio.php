...
$pdf->SetX('190');
$pdf->Cell(0,0,'$'.number_format($myrow71['ivas'],2),0,0,M);
...
$pdf->SetFont('Arial','',12);
$pdf->SetX(1);
$pdf->Cell(0,0,'CREDITO',0,0,M);


$pdf->SetFont('Arial','',10);

//$pdf->line(2,$y1,200,$y1);
$pdf->Ln(4); //salto de linea
$pdf->SetX(1);
$pdf->Cell(0,0,'Folio',0,0,M);
...
(cargosCuentaPaciente.precioVenta!='' and cargosCuentaPaciente.folioVenta)
and
(cargosCuentaPaciente.status='cxc' or cargosCuentaPaciente.status='otros')
and
cargosCuentaPaciente.statusCaja='pagado'
and
cargosCuentaPaciente.numCorte='".$_GET['numCorte']."'
