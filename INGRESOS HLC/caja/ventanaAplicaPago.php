...
//********************Llenado de datos
$sSQL3= "Select * From clientesInternos WHERE numeroE = '".$_GET['numeroE']."' ";
...
<form id="form1" name="form1" method="get" action="">
  ...
  <table width="290" border="0" align="center" cellpadding="0" cellspacing="0" class="Estilo24">
    <tr bgcolor="#990033" align="center">
      <td width="290" height="23"><p class="style12"><font color="#FFFFFF">Totales<br />
      </font></p>
      </td>
    </tr>
    <tr bgcolor="#990033">
      <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
          <tr bgcolor="#FFFFFF">
            <td class="Estilo24 style9">Tipo de Pago: </td>
            <td class="Estilo24"><select name="tipoPago" class="style13" id="tipoPago" onChange="javascript:form.submit();">
		  ...
		  <?php if($_GET['tipoPago']=='Tarjeta de Credito'){ ?>
            <td class="style10">C&oacute;digo de Tarjeta: </td>
            <td class="style10"><input name="codigo" type="text" class="Estilo24" id="codigo" 
		 value="<?php 
		 if($_GET['nuevo']){
		 echo "0000000000";
		 ...
		 ?>" size="10" readonly=""/>
          ...
          <tr bgcolor="#FFFFFF">
            <td bgcolor="#FFFFFF" class="style10">Banco Tarjeta :</td>
          ...
          <tr bgcolor="#FFFFFF">
            <td class="style10">&Uacute;ltimos 4 D&iacute;gitos: </td>
            <td class="Estilo24"><span class="style9">
              <label>
          ...
          <tr bgcolor="#FFFFFF">
            <td class="style10">C&oacute;digo de Aut. </td>
            <td class="Estilo24"><span class="style9">
              <label>
          ...
          <tr bgcolor="#FFFFFF">
            <td width="49%" class="style10">SubTotal: </td>
            <td width="51%" class="Estilo24"><span class="style9">
              <?php 
...
$descuento=$myrow18['cantidad'];
	...
	$TOTAL-=$descuento;
		...
		?>
          ...
          <?php } ?>
          <tr bgcolor="#FFFFFF">
            <td class="style10">IVA:</td>
            <td class="Estilo24"><span class="style13">
              <?php 
		  $sSQL13= "
	SELECT 
  sum(iva) as sumaiva
...
?>
          ...
          <tr bgcolor="#FFFFFF">
            <td class="style10">Total a Pagar: </td>
            <td class="Estilo24"><span class="style9"><?php echo "$".number_format($TOTAL+$iva,2);?></span></td>
          </tr>
          <tr bgcolor="#FFFFFF">
            <td class="style10">Cantidad Recibida </td>
            <td class="style10"><input name="cantidadRecibida" type="text" class="style7" id="cantidadRecibida" value="<?php echo $_GET['cantidadRecibida'];?>" autocomplete="off"/>
  ...
  <label>
	...
	/> <?php } ?>
		...
		'imprimeCaja1.php?descripcion=<?php echo $descripcion; ?>&amp;forma=<?php echo "form1"; ?>&amp;numeroE=<?php echo $nPaciente; ?>')" class="Estilo24">
    ...
    <p align="center"><span class="style8">
      <?php if($_GET['cantidadRecibida']){  //onclick="javascript:cerrar();"?>
