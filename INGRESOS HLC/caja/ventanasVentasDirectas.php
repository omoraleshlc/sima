...
$FV=$generaFolio-> generarFolioVenta("0",$usuario,"externo",$entidad,$tipoFolio,$basedatos);
//***************************************
...
<body>
<h1 align="center" class="titulos">Tipo de Pago o Transaccion</h1>
  <form id="form1" name="form1" method="post" action="">
    <table width="459" border="0" align="center" class="Estilo24">
    <tr>
      <th width="1" class="Estilo24" scope="col">&nbsp;</th>
      <th colspan="2" bgcolor="#990033" class="blancomid" scope="col">Datos de la Transacci&oacute;n</th>
    </tr>
     ...
     <tr>
       ...
       <td width="116" class="negro">Transacci&oacute;n </td>
       <td width="278" class="Estilo24">
	   <?php 
...
$myrow3171 = mysql_fetch_array($result3171);
	 ...
	 window.close();
	   ...
	   ?>
         ...
         <input name="campoDespliega" type="text" class="camposmid" id="campoDespliega" size="50" 
	value="<?php echo $myrow3171['descripcion'];?>"
     ...
     <tr>
       <th class="Estilo24" scope="col">&nbsp;</th>
       <td width="116" bgcolor="#FFFFFF" class="negro">Tipo Pago/Cr&eacute;dito </td>
       <td width="278" bgcolor="#FFFFFF" class="style16"><?php 
		 ?>
      ...
      <tr>
        <th class="Estilo24" scope="col">&nbsp;</th>
        <td bgcolor="#FFFFFF" class="cargos">Ultimos 4 d&iacute;gitos </td>
        <td bgcolor="#FFFFFF">
      ...
      <tr>
        <th class="Estilo24" scope="col">&nbsp;</th>
        <td bgcolor="#FFFFFF" class="cargos">Tel&eacute;fono</td>
        <td bgcolor="#FFFFFF"><input name="telefono" type="text" class="camposmid" value="" size="50"></td>
      </tr>
      ...
      <tr>
        <th class="Estilo24" scope="col">&nbsp;</th>
        <td bgcolor="#FFFFFF" class="cargos">Banco Tarjeta</td>
        <td bgcolor="#FFFFFF"><input name="bancoTC" type="text" class="camposmid" value="" size="50"  /></td>
      </tr>
	  <?php } ?>
      ...
      <tr>
       ...
       <td bgcolor="#FFFFFF" class="cargos">Banco Transferencia </td>
       <td bgcolor="#FFFFFF"><input name="bancoTransferencia" type="text" class="camposmid" value="" size="50"  /></td>
     </tr>
	 <?php } ?>
           ...
           <tr>
             <th class="Estilo24" scope="col">&nbsp;</th>
             <td bgcolor="#FFFFFF" class="cargos"># Transferencia </td>
             <td bgcolor="#FFFFFF">
			 <input name="numeroTransferencia" type="text" class="camposmid" id="numeroTransferencia" value="" size="50">			 </td>
           </tr>
 <?php } ?>		   
...
<?php if($_POST['tipoPago']=='Cheque'){ ?>		   
      <tr>
       ...
       <td bgcolor="#FFFFFF"><input name="numeroCheque" type="text" class="camposmid" id="numeroCheque" value="" /></td>
     </tr>
 <?php } ?>
	...
	<?php if($_POST['tipoPago']=='Cheque'){ ?> 
     <tr>
       ...
       <td class="Estilo24"><input name="bancoCheque" type="text" class="camposmid" id="bancoCheque" value="" size="50" /></td>
     </tr>
	  <?php } ?>
     ...
     <tr>
       <th class="Estilo24" scope="col">&nbsp;</th>
       <td colspan="2" bgcolor="#990033" class="Estilo24"><div align="center" class="blancomid">Datos del Cliente e Importe</div></td>
      </tr>
     <tr>
       <th class="Estilo24" scope="col">&nbsp;</th>
       <td class="negro">Nombre del Cliente </td>
       <td class="Estilo24"><input name="nombreCliente" type="text" class="camposmid" id="nombreCliente" value="" size="50" /></td>
     </tr>
     <tr>
      <th class="Estilo24" scope="col">&nbsp;</th>
      <td class="negro">Descripci&oacute;n</td>
      <td class="Estilo24">
	  <textarea name="descripcion" cols="50" class="camposmid" id="descripcion"></textarea></td>
    </tr>
     <tr>
       <th class="Estilo24" scope="col">&nbsp;</th>
       <td class="cargos">Departamento Cargo </td>
       <td class="Estilo24">
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
  ...
  <option value="" >---</option>
     ...
     <tr>
       <th class="Estilo24" scope="col">&nbsp;</th>
       <td class="cargos">Grupo de Producto </td>
       <td class="Estilo24"><span class="normal">
         <?php //*********gpoProductos
...
echo mysql_error();
     ...
     <tr>
       <th class="Estilo24" scope="col">&nbsp;</th>
       <td class="cargos">Devolucion?</td>
       <td class="Estilo24"><input name="devolucion" type="checkbox" id="devolucion" value="si" /></td>
     </tr>
     <tr>
      <th width="1" class="Estilo24" scope="col">&nbsp;</th>
      <td class="cargos">Importe</td>
      <td class="Estilo24"><label>
        <input name="cantidadRecibida" type="text" class="camposmid" id="cantidadRecibida" value="" autocomplete="off">
      </label></td>
    </tr>
