...
<form id="form10" name="form10" method="get" action="#">
  <h1 align="center" class="titulos">Ordenes paquetes pendientes </h1>
...
<!--
jQuery(function($) {
$("#contentArea").load("../../INGRESOS HLC/caja/listaPxPaquetes.php?warehouse=<?php echo $_GET['warehouse'];?>&almacenDestino1=<?php echo $_GET['almacenDestino1'];?>&fecha2=<?php echo $fecha2;?>&fecha1=<?php echo $date;?>&almacen=<?php echo $ALMACEN;?>&tipoOrden=<?php echo $_GET['tipoOrden'];?>&descripcionTransaccion=paquetes");
});
