...
$pdf->SetXY(1,25);
$pdf->Cell(0,0,'Notas Transferidas',0,0,M);
...
and
(cargosCuentaPaciente.precioVenta!='' and cargosCuentaPaciente.folioVenta)
and
...
order by 
cargosCuentaPaciente.folioVenta,clientesInternos.paciente ASC
 ";
...
$sSQL7="SELECT sum(cargosCuentaPaciente.cantidadAseguradora*cargosCuentaPaciente.cantidad) as efectivos
FROM
cargosCuentaPaciente
WHERE
...
$sSQL7="SELECT sum((cargosCuentaPaciente.precioVenta*cargosCuentaPaciente.cantidad)+(cargosCuentaPaciente.iva*cargosCuentaPaciente.cantidad)) as efectivos
FROM
cargosCuentaPaciente
WHERE
cargosCuentaPaciente.keyCAP='".$myrow['keyCAP']."'
...
$cos="$".number_format($myrow7['efectivos'],2);
...
$pdf->Cell(0,0,$prefijo.$myrow['folioVenta'],0,0,L);
