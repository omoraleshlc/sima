...
set
costo = '".$costo[$i]."', fechaModificacion='".$fecha1."',
usuario='".$usuario."'
...
<form id="form2" name="form2" method="post" action="" >
  <table width="200" class="table table-striped">
    ...
    <tr >
         <th width="10" >#</th>
     <th width="50" >AlmacenIngreso</th>
      <th width="320" >Descripcion</th>
      <th width="47" align="center" >Precio</th>
      <th width="70" align="center" >F.Inicial</th>
      <th width="68" align="center" >F. Final</th>
      <th width="42" align="center" >Quitar</th>
    </tr>
<?php	
...
<td bgcolor="<?php echo $bg;?>" height="46"><span >
        <?php
...
/>
      ...
      <td bgcolor="<?php echo $bg;?>"  align="center"><?php
	 ...
	 // echo $myrow2['existencias'];
      ...
      <td bgcolor="<?php echo $bg;?>" align="center"><span ><?php echo cambia_a_normal($myrow['fechaFinal'],2);
	  ?></span></td>
  ...
  <br />
  <span ><?php if($bandera){ ?>Se encontraron <?php echo $bandera; ?> Registros <?php }
	else {
  ...
  <input name="almacenDestino" type="hidden" id="almacenDestino"  value="<?php echo $_POST['almacenDestino']; ?>" />
    ...
    <table width="322" >
        <tr>
          <td width="123" align="center"><input name="actualizar" type="submit"  id="actualiza" value="Actualizar" /></td>
          <td width="21">&nbsp;</td>
          <td width="23">&nbsp;</td>
          <td width="155" align="center"><input name="eliminar" type="submit"  id="eliminar" value="Eliminar art&iacute;culos" /></td>
        </tr>
      </table>
    <?php }
