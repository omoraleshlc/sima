...
$myrow2 = mysql_fetch_array($result2)
    ...
    <tr>
      ...
      <th width="156" scope="col"><div align="left"><span class="style12">Escribe el nombre del art&iacute;culo </span></div></th>
      <th width="484" scope="col"><div align="left"><span class="style12">
          <input name="nomArticulo" type="text" class="style12" id="nomArticulo" size="80" value="<?php if($_POST['nomArticulo']) echo $_POST['nomArticulo']; ?>"/>
        </span></div>
          <span class="style12">
            </select>
          </span></th>
...
<?php if($leyenda){ ?>
<p align="center" class="style12">Leyenda: <?php echo $leyenda; ?></p>
<?php } ?>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="753" border="1" align="center">
    <tr>
      ...
      <th width="52" bgcolor="#660066" scope="col"><span class="style11"> Particular </span></th>
      <th width="75" bgcolor="#660066" scope="col"><span class="style11">Costo Sugerido  </span></th>
      <th width="90" bgcolor="#660066" scope="col"><span class="style11">Precio Aseguradora </span></th>
      <th width="51" bgcolor="#660066" scope="col"><span class="style11">Status</span></th>
    </tr>
    <tr>

<?php
if($_POST['ajustar']){
$ajustarArticulo=$_POST['nomArticulo'];
$sSQL= "
SELECT * FROM articulos

 WHERE descripcion LIKE '%$ajustarArticulo%' and
 activo='A'
 order by descripcion ASC";
...
?>
    ...
    <?php echo $C?>        </label>
      ...
      <td bgcolor="<?php echo $color?>" class="style16"><span class="Estilo24"><?php if($myrow7['precioAseguradora']){ echo "$".number_format($myrow7['precioAseguradora'],2);}
	  else 
	  {echo "Sin Precio";}
	  ?></span></td>
      <td bgcolor="<?php echo $color?>" class="style12"><span class="Estilo24">
        <?php if($myrow7['codigo']){ echo "Ingresado";}
	  else 
	  {echo "Sin Ingresar";}
	  ?>
      </span></td>
