...
if($_POST['actualizar'] AND $_POST['costo'] and $_POST['gpoProducto']){
...
'".$_POST['fechaInicial']."','".$_POST['fechaFinal']."','".$usuario."','".$_POST['almacenDestino1']."','".$_POST['costo']."','precioEspecial',
'".$_POST['gpoProducto']."','".$entidad."','".$fecha1."','".$_POST['incluirReferidos']."')";
mysql_db_query($basedatos,$agrega);
echo mysql_error();
echo 'Se agrego precio especial ';
...
<body>
  ...
  <p align="center" class="titulos">Precios Especiales</p>
  <form id="form1" name="form1" method="post" action="">
    <table width="200" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td colspan="3"><img src="../../imagenes/bordestablas/borde1.png" width="480" height="20" /></td>
      </tr>
   ...
   <th width="81" bgcolor="#CCCCCC" scope="col"><div align="right"><span class="normal"> Seguro </span></div></th>
      ...
      <tr>
        <td width="26" height="24" bgcolor="#CCCCCC">&nbsp;</td>
        <td width="66" bgcolor="#CCCCCC" class="negromid">Almacen</td>
        <td width="388" bgcolor="#CCCCCC"><label>
                <?php
$aCombo= "Select * From almacenes where
entidad='".$entidad."' AND
 activo='A' and (miniAlmacen ='' or miniAlmacen='No') order by descripcion ASC";
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
        <select name="almacenDestino" class="normal" id="almacenDestino" onchange="this.form.submit();"/>
  ...
  <option value="*" >Todos los Almacenes</option>
      ...
      <tr>
        <td width="26" height="24" bgcolor="#CCCCCC">&nbsp;</td>
        <td width="66" bgcolor="#CCCCCC" class="negromid">Mini-Almacen</td>
        <td width="388" bgcolor="#CCCCCC"><label>
                <?php
$aCombo= "Select * From almacenes where
entidad='".$entidad."' AND
    almacenPadre='".$_POST['almacenDestino']."'
        and
 activo='A' and miniAlmacen='Si' order by descripcion ASC";
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
        <select name="almacenDestino1" class="normal" id="almacenDestino" />
  ...
  <option value="*" >Todos los Almacenes</option>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCCC" class="negromid">Grupo de <br />
        Productos</td>
...
$result1=mysql_db_query($basedatos,$sSQL1); 
      ...
      <tr>
        ...
        <td bgcolor="#CCCCCC"><input name="costo" type="text" class="Estilo24" id="costo" size="4" maxlength="3"
		 value=""	/>
<span class="normal">Qu&eacute; porcentaje deseas agregar?</span></td>
      </tr>
      <tr>
        <td height="34" bgcolor="#CCCCCC">&nbsp;</td>
        <td bgcolor="#CCCCCC" class="negromid">Fechas<br /></td>
      ...
      <tr>
        <td colspan="3"><img src="../../imagenes/bordestablas/borde2.png" width="480" height="20" /></td>
      </tr>
    </table>
    <p>&nbsp;</p>
