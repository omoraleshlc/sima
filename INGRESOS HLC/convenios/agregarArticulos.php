...
?></span></p>
<p align="center"><span class="error"><?php echo $myrow1['nomCliente']; ?></span></p>
<form id="form2" name="form2" method="post" action="" >
<table width="336" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td colspan="3"><img src="../../imagenes/bordestablas/borde1.png" width="600" height="21" /></td>
    </tr>
  ...
  <tr>
         ...
         <td bgcolor="#CCCCCC" > <span  class="negromid">Seguro</span>     </td>
      ...
      <td bgcolor="#CCCCCC" class="codigos">
        ...
        <td bgcolor="#CCCCCC" colspan="4"><input name="nomSeguro" type="text" class="camposmid" id="nomSeguro" size="60"
		value="<?php
		if($_POST['nomSeguro']){
		...
		?>"/>
          ...
          <tr>
      <td width="24" height="24" bgcolor="#CCCCCC">&nbsp;</td>
    <td width="98" bgcolor="#CCCCCC" class="negromid">Departamento</td>
    <td width="478" bgcolor="#CCCCCC">
...
?>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC" class="negromid">Mini Almacen</td>
    <?php } ?>
...
?></td>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC" class="negromid">Fecha desde</td>
  ...
  <tr>
    <td height="21" bgcolor="#CCCCCC">&nbsp;</td>
    <td bgcolor="#CCCCCC" class="negromid">Hasta</td>
    <td bgcolor="#CCCCCC"><label>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC" class="negromid">&nbsp;</td>
    <td bgcolor="#CCCCCC"><input name="buscar" type="submit" class="Estilo24" id="actualizar" value="Buscar" /></td>
  </tr>
</table>
<img src="../../imagenes/bordestablas/borde2.png" width="600" height="21" />
<p>
...
<table width="200" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <td width="10" bgcolor="#FFFF00" class="negromid">#</td>
    <td width="255" bgcolor="#FFFF00" class="negromid">Descripcion</td>
    <td width="100" bgcolor="#FFFF00" class="negromid">Duracion</td>
    <td width="70" align="center" bgcolor="#FFFF00" class="negromid">P. Part</td>
    <td width="67" align="center" bgcolor="#FFFF00" class="negromid">P. Aseg</td>
    <td width="49" align="center" bgcolor="#FFFF00" class="negromid">Agregar</td>
    <td width="44" align="center" bgcolor="#FFFF00" class="negromid"> Quitar</td>
...
?>
  ...
  <tr bgcolor="#FFFF66" onMouseOver="bgColor='#cccccc'" onMouseOut="bgColor='#ffffff'" >
      ...
      <td height="50" bgcolor="<?php echo $bg;?>" class="negro">
      <?php 
    ...
    <?php }else{
        ...
        echo '<span class="negro">'.'Sin Asignar'.'</span>';
    ...
    <td bgcolor="<?php echo $bg;?>" align="right"><span class="precbluemid"><?php echo "$".number_format($myrow34['nivel1'],2);
         
		  ?></span></td>
    <td bgcolor="<?php echo $bg;?>" align="right"><span class="precredmid">
      <?php 
...
if($myrow18['costo']){
 ...
 echo "$".number_format($myrow18['costo'],2);
    ...
    <td bgcolor="<?php echo $bg;?>" align="center"><span class="precbluemid">
  ...
  <tr>
    <td colspan="7"><img src="../../imagenes/bordestablas/borde2.png" width="690" height="22" /></td>
    </tr>
</table>
<p>&nbsp;</p>
...
<p align="center"></p>
      ...
      <input name="eliminar" type="submit" class="Estilo24" id="eliminar" value="Eliminar articulos" />
      </label>
      <em>
      <?php }
	else {
