...
<form id="form2" name="form2" method="post" action="" >
    ...
    <table width="200" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td colspan="7"><img src="../../imagenes/bordestablas/borde1.png" width="650" height="24" /></td>
      </tr>
      <tr bgcolor="#FFFF00">
        <td width="91" class="negromid">Codigo</td>
        <td width="222" class="negromid">Descripcion</td>
        <td width="127" class="negromid">Dpto.</td>
        <td width="58" class="negromid" align="center">Porc.</td>
        <td width="71" class="negromid" align="center">F. Inicial</td>
        <td width="76" class="negromid" align="center">F. Final</td>
        <td width="45" class="negromid" align="center">Quitar</td>
      </tr>
 <?php	
...
?>
        ...
        <td align="center"><span class="camposmid" >
...
<td align="center"><span class="normalmid" >
          <?php 
	 ...
	 // echo $myrow2['existencias'];
      ...
      <td align="center"><span class="normalmid" ><?php echo cambia_a_normal($myrow['fechaFinal'],2);
	  ?> </span></td>
      <td align="center">
	  ...
	  ?>
      <tr>
        <td colspan="7"><img src="../../imagenes/bordestablas/borde2.png" width="650" height="24" /></td>
      </tr>
    </table>
    <br />
