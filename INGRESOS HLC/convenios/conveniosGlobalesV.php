...
<p>  <span align="center" class="titulos">Convenios Globales </span></p>
  ...
  <form id="form1" name="form1" method="post" action="">
    <table width="200" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td colspan="3"><img src="../../imagenes/bordestablas/borde1.png" width="450" height="20" /></td>
      </tr>
   ...
   <th width="81" bgcolor="#CCCCCC" scope="col"><div align="right"><span class="normal"> Seguro </span></div></th>
      ...
      <tr>
        <td width="17" height="31" bgcolor="#CCCCCC">&nbsp;</td>


        <td width="89" bgcolor="#CCCCCC" class="negromid">Almacen</td>
        <td width="394" bgcolor="#CCCCCC"><label>
...
$rCombo=mysql_db_query($basedatos,$aCombo); ?>
  ...
  <option value="*" >Todos los Almacenes</option>
      ...
      <tr>
        ...
        <td bgcolor="#CCCCCC"><input name="costo" type="text" class="normal" id="costo" size="3" maxlength="7"
      ...
      <tr>
        ...
        <td bgcolor="#CCCCCC" class="negromid">Fecha</td>
      ...
      <tr>
        <td colspan="3" bgcolor="#CCCCCC" align="center"><input name="actualizar" type="submit" class="Estilo24" id="actualizar" value="Crear Nuevo Convenio" />
      ...
      <tr>
        <td colspan="3"><img src="../../imagenes/bordestablas/borde2.png" width="450" height="20" /></td>
      </tr>
      <tr>
        <td colspan="3">&nbsp;</td>
      </tr>
