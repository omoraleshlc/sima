...
$pdf->SetXY(2,29);
if($myrow311['seguro']){
$sSQL1= "Select nomCliente,clientePrincipal From clientes WHERE entidad='".$myrow311['entidad']."' AND numCliente = '".$myrow311['seguro']."' ";
...
$pdf->SetXY(165,49);
$pdf->Cell(0,0,'Cargos',0,0,L);

$pdf->SetXY(186,49);
$pdf->Cell(0,0,'Abonos',0,0,L);
...
$pdf->Cell(0,0,$descripcion.$descripcionDescuento,0,0,L);
} else {
...
$pdf->Cell(0,0,'Dr(a): '.$myrow12a['descripcion'],0,0,L);
        if($myrow311['horaSolicitud']!=NULL){
          $pdf->Ln(4); //salto de linea
          $pdf->SetX('12');
          $pdf->Cell(0,0,'[Usted debe presentarse a las: '.$myrow311['horaSolicitud'] .']',0,0,L);  
          $pdf->Ln(4); //salto de linea
        }
}else{
