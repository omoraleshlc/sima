...
//saco departamento
$sSQL361a= "Select descripcion From almacenes WHERE 
entidad='".$myrow311['entidad']."' and
...
$sSQL361b= "Select descripcionPaquete From paquetes WHERE 
entidad='".$myrow311['entidad']."' and
codigoPaquete='".$_GET['codigoPaquete']."' ";
$result361b=mysql_db_query($basedatos,$sSQL361b);
$myrow361b = mysql_fetch_array($result361b);

$pdf->SetXY(2,$Y+10);
$pdf->Cell(0,0,'Servicios cargados del paquete: '.$myrow361b['descripcionPaquete'],0,0,L); 
