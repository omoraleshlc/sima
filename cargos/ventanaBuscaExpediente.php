...
<body>
<h1 align="center">Buscar Expediente </h1>
<?php echo $leyenda; ?>
  <form id="form2" name="form2" method="post" action="#" >
    <table width="545" align="center" cellpadding="0" cellspacing="0" class="style71" style="border: 1px solid #000000;">
      ...
      <tr valign="middle" bgcolor="#FFCCFF" class="catalogo">
        <td width="140"><div align="left" class="style71">Apellido Paterno, Materno </div></td>
...
<table width="377" border="0" align="center">
    <tr>
        ...
        <th width="225" bgcolor="#660066" scope="col"><div align="left"><span class="style11">Paciente</span></div></th>
        <th width="50" bgcolor="#660066" scope="col"><div align="left"><span class="style111">Fecha Nac </span></div></th>
...
onClick="javascript:regresar('<?php echo $myrow['numCliente'];?>','<?php echo $nombrePaciente;?>','<?php echo $myrow['fechaNacimiento'];?>','<?php echo $edad;?>')">
        <?php 
		...
		echo $nombrePaciente.' '.$interno.' '.'<span class="style112">'.$jubilado.'</span>';?>
