...
$sSQL11= "Select  * From articulos,existencias where articulos.entidad='".$entidad."' 
and 
...
?>
      <td height="24" bgcolor="<?php echo $color;?>" class="Estilo24"><span class="style7">
        <label></label>
       <a href="javascript:regresar('<?php echo $myrow11['codigo'];  ?>','<?php echo $myrow11['descripcion']; ?>');"><?php echo $myrow11['codigo'];  ?></a></span></td>
