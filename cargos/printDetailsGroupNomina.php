...
//***********************
$precioVenta[0]+=$myrow7['acumulado']-$myrow7d['acumulado'];
$iva[0]+=$myrow7['sumaIVA']-$myrow7d['sumaIVA'];
//**********************
...
$sumaIVA[0]+=($myrow['sumaIVA']-$myrow7d['sumaIVA']);
...
$pdf->SetFont('Arial','',10);
$pdf->SetXY(1,218);
$pdf->Cell(0,0,"$".number_format($precioVenta[0]-$coaseguro[0],2),0,0,R);
...
$TOTAL=($precioVenta[0]+$iva[0])-$coaseguro[0];
