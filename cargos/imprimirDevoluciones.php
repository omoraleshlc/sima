...
$TOTALESC[0]+=($myrow['precioVenta']*$myrow['cantidad']);

$signo='';
} else if($myrow['naturaleza']=='A'){
$TOTALESA[0]+=($myrow['precioVenta']*$myrow['cantidad']);
$signo='-';
}

$IVA[0]+=($myrow['iva']*$myrow['cantidad']);
...
$pdf->Ln(2); //salto de linea
$pdf->SetX('7');
$pdf->Cell(0,0,'Folio de Cancelado: '.$myrow311['folioDevolucion'],0,0,L);
$pdf->Ln(5); //salto de linea




$TOTAL=$TOTALESC[0]+$IVA[0];
...
$pdf->Cell(0,0,"Subtotal: "."$".number_format($TOTALESC[0],2),0,0,R);




$pdf->SetY($Y+5);
$pdf->Cell(0,0,"Iva: "."$".number_format($IVA[0],2),0,0,R);
$pdf->SetY($Y+10);
$pdf->Cell(0,0,"Total: "."$".number_format($TOTALESC[0]+$IVA[0],2),0,0,R);
