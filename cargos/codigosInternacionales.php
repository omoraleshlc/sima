...
<body>
<h1 align="center">Agregar C&oacute;digo Internacional </h1>
...
<table width="582" border="0" align="center">
    <tr>
        ...
        <th width="34" bgcolor="#660066" scope="col"><div align="left"><span class="style111">Agregar</span></div></th>
...
<a href="#" rel="htmltooltip" onClick="javascript:regresar('<?php echo $myrow['numCliente'];?>','<?php echo $nombrePaciente;?>')">
        <?php 
			echo $myrow['CI'];
		  ...
		  <td bgcolor="<?php echo $color;?>" class="Estilo24"><span class="Estilo29"><span class="Estilo30"><a href="#" rel="htmltooltip" onclick="javascript:regresar('<?php echo $myrow['numCliente'];?>','<?php echo $nombrePaciente;?>')">
		    <?php 
		...
		<span class="style12">
		<input name="keyDiagnosticos[]" type="checkbox" id="keyDiagnosticos[]" value="<?php echo $myrow['keyDiagnosticos'];?>" />
		</span> </span></td>
	...
	<p align="center">
	  <input name="agregar" type="submit" class="style7" id="agregar" value="Agregar Diagn&oacute;sticos" />
</p>
	<p>
