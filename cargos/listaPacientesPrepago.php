...
<body>
<h1 align="center">Pacientes Prepago <?php echo $leyenda; ?>
  </h1>
...
<a href="#" 
onClick="javascript:regresar('<?php echo $myrow['numeroE'];?>','<?php echo $myrow['paciente'];?>','<?php echo $myrow['keyClientesInternos'];?>','prepago')">
        <?php 
			echo $myrow['numeroE'];
