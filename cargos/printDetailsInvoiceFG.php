...
$myrow7['acumulado']= $myrow7['acumulado']*$porcentaje;

//print $porcentaje;

$pdf->Cell(0,0,'$'.number_format( $myrow7['acumulado'],2),0,0,L);
$pdf->SetX('185');
$pdf->Cell(0,0,'$'.number_format($myrow7['acumulado']*$myrow['cantidad'],2),0,0,R);
$ss[0]+=($myrow7['acumulado']*$myrow['cantidad']);
//cantidad
//$pdf->SetX('27');
