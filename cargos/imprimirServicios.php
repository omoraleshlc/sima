...
<table width="600" class="table table-striped">
    <tr>
      ...
      <th width="100" scope="col"><div align="left" ><span >Anaquel</span></div></th>
...
$id_almacenb=$myrow18['almacenDestino'];
$b+='1';
$a+='1';
...
$sSQL7= "Select * From existencias WHERE entidad='".$entidad."' and codigo= '".$code1."' and almacen='".$id_almacenb."'";
