...
$cargo[0]+=$myrow['cantidadAseguradora']*$myrow['cantidad'];
$cargoIva[0]+=$myrow['ivaAseguradora']*$myrow['cantidad'];
$signo='';
}else{
$abono[0]+=$myrow['cantidadAseguradora']*$myrow['cantidad'];
$abonoIva[0]+=$myrow['ivaAseguradora']*$myrow['cantidad'];
$signo='-';
}
//*************************
...
$pdf->Cell(0,0,$signo.'$'.number_format( $myrow['cantidadAseguradora'],2),0,0,L);

$pdf->SetX('185');
$pdf->Cell(0,0,$signo.'$'.number_format($myrow['cantidadAseguradora']*$myrow['cantidad'],2),0,0,R);
