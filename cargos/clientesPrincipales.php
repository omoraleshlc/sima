<?php
	...
	$sql="SELECT numCliente,nomCliente FROM clientes WHERE entidad='".$_GET['entidad']."' and nomCliente LIKE '%$q%' and subCliente='' and clientePrincipal='' order by nomCliente ASC";
	//echo $sql;
