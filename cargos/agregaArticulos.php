...
<input name="numeroE" type="hidden" value="<?php echo $_GET['numeroE']?>" />
    ...
    <table width="428" >
      <tr>
        ...
        <td width="40">&nbsp;</td>
        <!--td width="118" align="center"><input name="close" type="submit"  id="close"  onclick="cerrarVentana()" class="boton2" value="okok"/></td-->
      </tr>
    </table>
    <p>&nbsp; 
    </p>
...
$sSQL455f= "Select requiereMatricula from clientes where entidad='".$entidad."' and numCliente='".$myrow1s['clientePrincipal']."'";
...
window.close();
 ...
 <?php }else{
     ...
     if($myrow1s['despliegaEC']!='si'){
require("../cargos/muestraECuentas.php");
     }

//$show->mostrarDatos($myrow7ll['credencial'],$_GET['keyClientesInternos'],$myrow7ll['seguro'],$myrow7ll['clientePrincipal'],$myrow7ll['paciente'],$fecha1,$entidad,$basedatos,$_GET['numeroE']);
