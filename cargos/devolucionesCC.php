...
if($_POST['aplicar'] and $_POST['keyCAP']){
$keyCAP=$_POST['keyCAP'];
...
$q4 = "INSERT INTO contadorInternos (contador,usuario,entidad) values ('".$myrow333['conta']."','".$usuario."','".$entidad."')";
mysql_db_query($basedatos,$q4);
echo mysql_error();
...
if($keyCAP[$i]){
 ...
 $sSQL1= "
Select * From cargosCuentaPaciente WHERE keyCAP='".$keyCAP[$i]."'   ";
...
if($myrow1['gpoProducto']!='' and $myrow1['statusDescuento']!='si' ) { 

if($myrow1['statusCortesia']=='si' || $myrow1['statusBeneficencia']=='si' || $myrow1['statusDescuento']=='si') { 
$naturaleza='C';
}else{
$naturaleza='A';
}
...
almacenSolicitante,almacenDestino,keyClientesInternos,descripcion,statusFactura,horaSolicitud,fechaSolicitud,codigoTarjeta,ultimosDigitos,codigoAutorizacion,numeroCheque,
bancoTransferencia,bancoCheque,numeroTransferencia,banderaPC,statusPC,clientePrincipal,folioVenta,codigoCaja,numRecibo,numCorte,keyE,keyPA,numeroConfirmacion,
...
statusDevolucion,statusCortesia,statusBeneficencia,statusDescuento,numMovimiento) 
values 
('".$myrow1['numeroE']."',
'".$myrow1['nCuenta']."',
'".$myrow1['status']." ',
...
'".$myrow333['NS']."','".$myrow1['keyCAP']."' ,'".$myrow1['descripcionArticulo']."' ,
'si','','','','".$myrow333a['CVI']."'
...
'".$FV."','".$myrow1['almacen']."','devolucion'
)";
mysql_db_query($basedatos,$agrega1);
echo mysql_error();
}//verificando folio devolucion
//***************************************************
...
<h1 align="center" class="titulos">Estado de Cuenta, cuentas cerradas </h1>
<h1 align="center" class="titulos">&nbsp;</h1>
<p align="center" class="codigos">*Escoja el numero de movimiento para devolver </p>
...
?>
  ...
  <table width="988" border="0" align="center">
    <tr bgcolor="#330099">
      <th width="40" class="blanco" scope="col"><div align="center"><span class="blanco ">Mov</span></div></th>
      ...
      <th width="50"  scope="col"><div align="center"><span class="blanco ">Dev</span></div></th>
    </tr>
...
?>	
      ...
      <td bgcolor="<?php echo $color;?>" class="<?php echo $style;?>"><?php echo $myrow81['numMovimiento'];?>
...
<td class="<?php echo $style;?>"><div align="center"><?php print $myrow81['cantidad']; ?></div></td>
      ...
      <td class="precionormal2" >
        <div align="right">
          <label>
          <input name="keyCAP[]" type="checkbox" id="keyCAP" value="<?php echo $myrow81['keyCAP'];?>"  <?php if($myrow81['folioDevolucion'])echo 'disabled=""';?> />
          </label>
        </div></td>
      </tr>
...
<div align="center">
            <div align="left">
              <p align="center">
                <label>
                <input name="aplicar" type="submit" id="aplicar" value="Devolver Movimientos" />
                </label>
              </p>
    </div>
  </div>
