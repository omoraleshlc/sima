...
<form id="form1" name="form1" method="post" action="">
  <table width="404" border="1" align="center">
    <tr>
      <th width="71" height="19" bgcolor="#660066" scope="col"><div align="left"><span class="style11">Cuenta Mayor </span></div></th>
    ...
    <tr>
         ...
         <?php //*********
$cmdstr1 = "select distinct * from MATEO.CONT_CTAMAYOR WHERE 
ID_EJERCICIO='".$ID_EJERCICIOM."' AND

DETALLE ='S' ORDER BY NOMBRE ASC";
...
?>
      <td height="24" bgcolor="<?php echo $color;?>" class="Estilo24"><span class="style7">
        <label></label>
       <a href="javascript:regresar('<?php echo $results1['ID_CTAMAYOR'][$i];  ?>','<?php echo $results1['NOMBRE'][$i];  ?>');"><?php echo $results1['ID_CTAMAYOR'][$i];  ?></a></span></td>
