...
and
clienteFacturacion='".$_GET['seguro']."'
and
((naturaleza='C' and statusDevolucion!='si') or (naturaleza='A' and statusDevolucion='si'))
and
...
$C=$myrow['codigoGP'];
$pdf->Ln(3); //salto de linea
$myrow['precioVenta']=$myrow['cantidadAseguradora'];
$myrow['iva']=$myrow['ivaAseguradora'];
...
//*******************MOVIMIENTOS
$sSQL7="SELECT SUM(cantidadAseguradora) as acumulado,SUM(ivaAseguradora) as sumaIVA
FROM
...
$totalF=$tasaCero[0]+$tasaIVA[0]+$tasaExento[0]+$sumaIVA[0];
...
$ss[0]=$ss[0]-$coaseguro[0];


$TOTAL=number_format($ss[0]+$sumaIVA[0],2);
...
$pdf->SetXY(22,222);
$pdf->Cell(0,0,'Tasa al '.$myrow38a['codTASA'].'16% '."$".number_format($tasaIVA[0],2),0,0,M);
$pdf->SetXY(22,226);
