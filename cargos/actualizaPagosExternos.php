...
if($myrow1['tipoPaciente']=='externo' or ((($myrow1['tipoPaciente']=='interno' or $myrow1['tipoPaciente']=='urgencias')) and $myrow1['fechaCargo']==$fecha1)){
...
echo 'Error: La fecha debe ser menor!';
