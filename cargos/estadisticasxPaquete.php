...
Estadisticas por Paquetes</h1>
   ...
   <table width="1200" class="table table-striped"	>


     <tr >
       <td width="407" ><div align="center">Seguro</div></td>
...
/*  echo $myrow6['numCliente'];
 echo '<br>'; */
         if($myrow2['descripcionMedico']){
 echo $myrow2['descripcionMedico'];
         }else{
          echo 'Medico baja'   ;
         }
		  ?>
...
almacenSolicitante='".$_GET['almacen']."'
and
almacenDestino='".$myrow2['almacenDestino']."'
and
...
$sSQL6ad= "Select sum(cantidad) as dev  From cargosCuentaPaciente where
    entidad='".$entidad."'
and
almacenSolicitante='".$_GET['almacen']."'
and
...
gpoProducto='".$gpoProducto."'
    ...
    paquete='si'
";
$resultci1t=mysql_db_query($basedatos,$sSQLci1t);
$myrowci1t = mysql_fetch_array($resultci1t);
...
";
$resultci2t=mysql_db_query($basedatos,$sSQLci2t);
$myrowci2t = mysql_fetch_array($resultci2t);
echo $myrowci1t['pV']-$myrowci2t['pVDev'];
