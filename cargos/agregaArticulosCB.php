...
function setFocus()
{
var field = document.nomArticulo;
field.focus();
...
<p align="center">
  ...
  <span class="style15"><?php echo $leyenda; ?></span><img src="cb.jpg" width="150" height="84" /></p>
<form id="form1" name="form1" method="post" action="">
  <table width="419" border="1" align="center">
    <tr>
      <th width="103" scope="col"><div align="center"><span class="Estilo24">Cargar Materiales </span></div></th>
      <th width="300" scope="col"><div align="left"><span class="Estilo24">
	  
          <input name="nomArticulo" type="text" class="Estilo24" id="nomArticulo" size="60" value="<?php if($_POST['nomArticulo']) echo $_POST['nomArticulo']; 
...
echo $nombrePaciente1;
    ...
    <table width="517" border="1" align="center" class="style7">
      <tr>
