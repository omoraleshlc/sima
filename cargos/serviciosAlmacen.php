...
AND 
articulos.descripcion  not like '%dr.%' and
articulos.um='s'
...
?>
    <table width="649" border="1" align="center">
      <tr>
        ...
        <th width="387" bgcolor="#660066" scope="col"><span class="style11">Descripci&oacute;n</span></th>
        <th width="18" bgcolor="#660066" scope="col"><span class="style11">UM</span></th>
        <th width="17" bgcolor="#660066" scope="col"><span class="style11">E</span></th>
        <th width="37" bgcolor="#660066" scope="col"><span class="style11">Anaquel</span></th>
        <th width="26" bgcolor="#660066" scope="col"><span class="style11">Precio</span></th>
...
?>
        ...
        <td bgcolor="<?php echo $color;?>" class="Estilo24"><span class="style7"><?php echo $myrow12['um']; ?></span></td>
	...
	if($co){
	echo "Se encontraron $bandera artículos..";
	}
	?>&nbsp;</p>
    <p align="center">
      <label>
    ...
    <?php } ?>
    <input name="almacen" type="hidden" id="numPaciente2" value="<?php echo $_POST['almacen']; ?>" />
