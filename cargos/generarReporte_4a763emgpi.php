...
<!--MMDW 2 --><script language=javascript> 
...
<html mmdw="1"  xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta mmdw="2"  http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
...
<h1 mmdw="3"  align="center">Folios de Venta
<!--MMDW 4 --><?php   // (fechaCierre between '".$_GET['fechaInicial']."' and '".$_GET['fechaFinal']."')
...
<p mmdw="4"  align="center">

</p>
<p mmdw="5"  align="center">
<!--MMDW 6 --><?php	
...
dia,diaNumerico,mes,year,clientePrincipal,cantidad,primeraVez,almacenSolicitud,almacenDestino)
values
...
'".$myrow['clientePrincipal']."','".$myrow2['cantidad']."','".$myrow['primeraVez']."','".$myrow2['almacenSolicitante']."','".$myrow2['almacenDestino']."'
...
<p mmdw="6"  align="center">

</p>

  <!--MMDW 10 --><script>window.close();
  </script><!--MMDW 11 -->
