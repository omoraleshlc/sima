...
$pdf->SetXY(2,5);
$pdf->Cell(0,0,'FOLIOS DE VENTA',0,0,M);
$pdf->SetX(1);
...
if(!$_GET['folioFactura']){
    $_GET['folioFactura']=$_GET['numFactura'];
}


$fecha1=$_GET['fecha'];
$pdf->SetY(10);
$pdf->Cell(0,0,'FACTURA #: '.$_GET['folioFactura'],0,0,R);
...
//*********************************************************************************
 $sSQLefectivo="SELECT sum(importe*cantidad)  as i
...
$sSQLefectivod="SELECT sum(importe*cantidad) as devolucionesParticular
...
$pagoEfectivo=$myrowefectivo['i']-$myrowefectivod['devolucionesParticular'];
$totalEfectivo[0]+=$myrowefectivo['i']-$myrowefectivod['devolucionesParticular'];
//****************************************************************
