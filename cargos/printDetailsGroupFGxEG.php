...
$sSQL7d="SELECT SUM(cantidadAseguradora*cantidad) as acumulado,SUM(ivaAseguradora*cantidad) as sumaIVA
  FROM
  cargosCuentaPaciente
  WHERE
  folioVenta='".$_GET['folioVenta']."'
...
$myrow38d['porcentajeFacturacion']=$myrow['porcentajeFacturacion'];
