...
<table width="400" class="table-forma">
  <tr>
    <td  align="left">&nbsp;</td>
    <td  align="left"><span >Folio de Venta: <?php echo $myrow1['folioVenta'];
...
?></span></td>
  ...
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><span >Cuarto:<?php echo $myrow1['cuarto'];
...
?></span></td>
  ...
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><span >Medico Internamiento:
	<?php $medic= $myrow1['medico'];
	$sSQL3= "Select descripcion From almacenes WHERE entidad='".$entidad."' and almacen='".$medic."';
";
...
<form id="form1" name="form1" method="post" action="">
  <table width="808" class="table table-striped">
    <tr>
      <th width="74" scope="col"><div align="left" ><span ># Solicitud</span></div></th>
      <th width="204" scope="col"><div align="center" ><span >Hora y Fecha Levantamiento Muestra</span></div></th>
      <th width="104" scope="col"><div align="left" >
        <div align="center"><span >Hora y Fecha Solicitud</span></div>
      </div></th>
      <th width="289" scope="col"><div align="left" ><span >Descripci&oacute;n</span></div></th>
      <th width="65" scope="col"><div align="left" ><span >Solicita</span></div></th>
      <th width="53" scope="col"><div align="left" >
        <div align="center"><span >Cant.</span></div>
      </div></th>
      <th width="39" scope="col"><div align="left" >
        <div align="center"><span >Status</span></div>
      </div></th>
    </tr>
    <tr>
...
and
(almacenDestino='".$_GET['almacen']."' or almacen='".$_GET['almacen']."')
and
random='".$_GET['rand']."'
...
<?php echo $myrow18['keyCAP'];?></div></td>
  ...
  <div align="center">
    <label><br />
    <input name="print" type="submit"  id="print" value="Imprimir"  onclick="imprimir();"/>
    </label>
</div>
  <p align="center">&nbsp;</p>
</form>
