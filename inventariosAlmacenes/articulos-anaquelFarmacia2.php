...
?>
  ...
  <table width="665" border="1" align="center">
    <tr>
      <th width="112" bgcolor="#660066" scope="col"><span class="style11">Almac&eacute;n </span></th>
      <th width="163" bgcolor="#660066" scope="col"><span class="style11">Agregar Almacenes </span></th>
      <th width="266" bgcolor="#660066" scope="col"><span class="style11">Anaquel </span></th>
      <th width="46" bgcolor="#660066" scope="col"><span class="style11">Agregar
        <label></label>
      </span></th>
      <th width="44" bgcolor="#660066" scope="col"><span class="style11">Quitar</span></th>
    </tr>
    <tr>
      <?php   
 $sSQL= "Select distinct * From almacenes 
 where (ventas='Si' or ventas='si') and activo='A'
 ...
 ?>  
      ...
      <td bgcolor="<?php echo $color?>" class="<?php echo $estilo;?>"><span class="style7"><?php echo $myrow['descripcion'];?></span>
          <input name="pasoBandera" type="hidden" id="pasoBandera" value="<?php echo $bandera; ?>" />
               <input name="almacen[]" type="hidden" id="almacen[]" value="<?php echo $myrow['almacen']; ?>" />      </td>
      <td bgcolor="<?php echo $color?>" class="style7"><label>
        <?php //*********Unidades de Medida
	 
 $sSQL71= "Select distinct * From anaqueles 
 where
 almacen='".$alma."'
...
echo mysql_error();
 $codigoAnaquel=$myrow10['anaquel'];
$sSQL11= "SELECT 
 *
FROM
  anaqueles
  WHERE 
  anaquel='".$codigoAnaquel."'
  ";
...
$myrow12 = mysql_fetch_array($result12);
	  ...
	  ?>
        <select name="anaquel" class="style12" id="anaquel">
          <?php 		if($myrow10['anaquel']){ ?>
          <option value="<?php echo $myrow10['anaquel']; ?>"><?php echo $myrow10['anaquel']." || ".$myrow12['tipoAnaquel']; ?></option>

          <?php } ?>
		  <option value="">---</option>
          <?php  	 		 
		   while($myrow71 = mysql_fetch_array($result71)){ ?>
          <option value="<?php echo $myrow71['anaquel']; ?>"><?php echo $myrow71['anaquel']." || ".$myrow12['tipoAnaquel'];; ?></option>
          <?php } 
