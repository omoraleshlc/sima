...
$myrow3 = mysql_fetch_array($result3);        
       ...
       if(!$myrow3['extension'] and $road[$i]>0){ 
$agrega = "INSERT INTO usersmodules (

main,primario,secondary,extension,usuario,entidad,rol
...
'".$_GET['usuario']."','".$_GET['entidades']."','si'
...
while($myrow3a = mysql_fetch_array($result3a)){      
...
'".$myrow3a['main']."','".$myrow3a['primario']."','".$myrow3a['secondary']."',

'".$road[$i]."',

'".$myrow3a['usuario']."','".$_GET['entidades']."','si','".$_GET['usuario']."'
...
$borrame = "DELETE FROM usersmodules WHERE 
