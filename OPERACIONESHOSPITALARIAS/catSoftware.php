...
<iframe  src="../ventanas/ventanaCatalogoSoftware.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
...
<iframe   src="../ventanas/ventanaCatalogoTipoProcesador.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
        frameborder="0" width="100%" height="1450">
    Si ves este mensaje, significa que tu navegador no tiene soporte para marcos o el mismo está deshabilitado.
    </iframe>        
...
<iframe src="../ventanas/ventanaCatalogoOS.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
        frameborder="0" width="100%" height="1450">
    Si ves este mensaje, significa que tu navegador no tiene soporte para marcos o el mismo está deshabilitado.
    </iframe>        
...
<iframe src="../ventanas/ventanaCatalogoMarcasMonitores.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
        frameborder="0" width="100%" height="1450">
    Si ves este mensaje, significa que tu navegador no tiene soporte para marcos o el mismo está deshabilitado.
    </iframe>        
...
<iframe src="../ventanas/ventanaCatalogoMarcas.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
        frameborder="0" width="100%" height="1450">
    Si ves este mensaje, significa que tu navegador no tiene soporte para marcos o el mismo está deshabilitado.
    </iframe>        
...
<iframe src="../ventanas/ventanaCatalogoTipoEquipo.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
        frameborder="0" width="100%" height="1450">
    Si ves este mensaje, significa que tu navegador no tiene soporte para marcos o el mismo está deshabilitado.
    </iframe>        
