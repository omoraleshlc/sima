...
<form id="form1" name="form1" method="post" action="">
    ...
    <p>&nbsp;</p>
    <p align="center">
      <input onMouseOver="Tip('&lt;div class=&quot;estilo25&quot;&gt;<?php echo 'Presiona aqu&iacute; para hacer notas de credito..';?>&lt;/div&gt;')" onMouseOut="UnTip()" name="nuevo2" type="button"  id="nuevo2" src="../imagenes/btns/generarventa.png"
	  onclick="abrirVentaDirecta();" value="NOTA DE CREDITO" />
	  ...
	  onclick="nueva('/sima/cargos/listadoVentasPacientes.php?paquetes=paquetes&amp;almacen=<?php echo $ALMACEN;?>','ventanaSecundaria10','500','500','yes')" value="VER NCs" />
      <label></label>
    </p>
</form>
<h1 align="center">&nbsp;</h1>
...
ventanaVD = new Window('dialog3', {className: "alphacube", title: "NOTAS DE CREDITO A PACIENTES", 
								  top:15, right:500, width:600, height:600, 
								  url: "../ventanas/ventanaNotaCredito.php?cargos=cargos&amp;almacen=<?php echo $ALMACEN;?>", showEffectOptions: {duration:1}})
