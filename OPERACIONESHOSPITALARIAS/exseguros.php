...
<br /><br />
   ...
   <?php
   if($_GET['fv']!=NULL){
   if($_GET['mes']!=NULL and $_GET['year']!=NULL and $_GET['gpoProducto']!=NULL){ ?>
...
<div id="liga1">
&nbsp; <br />
	   <a href="javascript:ventanaSecundaria51('../cargos/estadisticasxAseguradora.php?almacen=<?php echo $_GET['datawarehouse'];?>&year=<?php echo $_GET['year']; ?>&mes=<?php echo $_GET['mes']; ?>&random=<?php echo $random;?>&gpoProducto=<?php echo $_GET['gpoProducto'];?>')">x Aseguradora </a><br />
...
<div id="liga2">
&nbsp; <br />
           <a href="javascript:ventanaSecundaria51('../cargos/estadisticasxMedico.php?almacen=<?php echo $_GET['datawarehouse'];?>&amp;year=<?php echo $_GET['year']; ?>&amp;mes=<?php echo $_GET['mes']; ?>&amp;random=<?php echo $random;?>&gpoProducto=<?php echo $_GET['gpoProducto'];?>')">
               x Medico
           </a><br />
...
<div id="liga3">
&nbsp; <br />
           <a href="javascript:ventanaSecundaria51('../cargos/estadisticasxPaquete.php?almacen=<?php echo $_GET['datawarehouse'];?>&amp;year=<?php echo $_GET['year']; ?>&amp;mes=<?php echo $_GET['mes']; ?>&amp;random=<?php echo $random;?>&gpoProducto=<?php echo $_GET['gpoProducto'];?>')">
               x Paquetes
           </a><br />
