...
<iframe src="../ventanas/ventanaCatalogoTelefoniaCelular.php?solicitud=<?php echo $n; ?>&main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&solicitud=<?php echo $n;?>&test=10"  
