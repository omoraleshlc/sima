...
if($myrow31['folioVenta']!=NULL and ($myrow31['statusCuenta']!='revision' or $myrow31['statusCuenta']!='abierta')){
$tipoMensaje='Error';
$encabezado='Error!';
$texto='La cuenta esta en: '.$myrow31['statusCuenta'].', y debe estar en revision o abierta para poder aplicar la devolucion del servicio correspondiente..';
}
*/
?>
...
folioVenta='".$_POST['folioVenta']."'
and
(statusCuenta='revision' or statusCuenta='abierta' )
";
...
?></td>
      ...
      <a href="#" onClick="javascript:ventanaSecundaria1('/sima/cargos/aplicarDevolucionesServicios.php?numeroE=<?php echo $myrow['numeroE']; ?>&amp;nCuenta=<?php echo $myrow['nCuenta']; ?>&amp;almacen=<?php echo $ALMACEN; ?>&amp;almacenFuente=<?php echo $ALMACEN; ?>&amp;nT=<?php echo $nT; ?>&amp;tipoCliente=<?php echo $tipoCliente;?>&amp;tipoMovimiento=<?php echo 'cierreCuenta';?>&amp;tipoPaciente=interno&amp;folioVenta=<?php echo $myrow['folioVenta'];?>')">
