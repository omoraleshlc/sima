...
$sSQL1= "Select * From sis_relacionTCEquipos WHERE entidad='".$entidad."'
    and
...
$agrega = "INSERT INTO sis_relacionTCEquipos (
...
if(!$_POST['update'] and !$_POST['ADDIP'] and $_GET['keyTC']>0 and $_GET['del']=='si'){
 ...
 $q = "DELETE FROM sis_relacionTCEquipos
