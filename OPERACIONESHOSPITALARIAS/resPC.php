...
if ($_POST['ADDOS'] != NULL and $_GET['solicitud'] > 0) {
    ...
    $sSQL1 = "Select * From sis_relacionOSEquipos WHERE entidad='" . $entidad . "'
    and
    ...
    $sqlNombre11 = "SELECT * from sis_sistemaOperativo
...
where keyOS='" . $_POST['keyOS'] . "'";
    ...
    if (!$myrow1['solicitud']) {
        ...
        $agrega = "INSERT INTO sis_relacionOSEquipos (
...
//******************** INSERTAR Y ACTUALIZAR ************************************
        ...
        if ($myrow1['solicitud']) {
            //echo "actualiza";
            $q = "UPDATE sis_inventarioEqComputo set 
...
if (isset($_GET['isUpdate'])) {
    ...
    $sSQL1a = "Select * From entidades WHERE codigoEntidad = '" . $myrow1['entidad'] . "'";
    $result1a = mysql_db_query($basedatos, $sSQL1a);
    $myrow1a = mysql_fetch_array($result1a);



    $sSQL1b = "Select * From almacenes WHERE entidad='" . $myrow1['entidad'] . "' and almacen = '" . $myrow1['almacen'] . "'";
    $result1b = mysql_db_query($basedatos, $sSQL1b);
    $myrow1b = mysql_fetch_array($result1b);
    
    $sSQL1c = "Select * From sis_relacionOSEquipos WHERE entidad='" . $myrow1['entidad'] . "' and solicitud = '" . $myrow1['solicitud'] . "'";
    $result1c = mysql_db_query($basedatos, $sSQL1c);
    $myrow1b = mysql_fetch_array($result1c);
    
    $sSQL1d = "Select * From sis_relacionSWEquipos WHERE entidad='" . $myrow1['entidad'] . "' and solicitud = '" . $myrow1['solicitud'] . "'";
    
    $sSQL1e = "Select * From sis_relacionTCEquipos WHERE entidad='" . $myrow1['entidad'] . "' and solicitud = '" . $myrow1['solicitud'] . "'";
    
    
    $_POST['entidad']=$myrow1['entidad'];
    $_POST['almacen']=$myrow1['departamento'];
    $_POST["keyTE"]=$myrow1['keyTE'];
    $_POST["keyMA"]=$myrow1['keyMA'];
    $_POST["keyTP"]=$myrow1['keyTP'];
}
?>
...
?>
                            ...
                            while ($rNombre11 = mysql_fetch_array($resultaNombre11)) {
                                ...
                                ?>
                                    <option
                                <?php if ($_POST["entidad"] == $rNombre11['codigoEntidad']) {
                                    echo 'selected=""';
                                } ?>
...
?>
                        ...
                        while ($rNombre11 = mysql_fetch_array($resultaNombre11)) {
                            ...
                            ?>
                                    <option
    <?php if ($_POST["almacen"] != NULL AND ($_POST["almacen"] == $rNombre11["almacen"])) {
        echo 'selected=""';
    } ?>
                ...
                <tr>
                    ...
                    <td>
<?php
$sqlNombre11 = "SELECT * from sis_tipoEquipo 
...
?>
                        ...
                        while ($rNombre11 = mysql_fetch_array($resultaNombre11)) {
                            ...
                            ?>
                                    <option
    <?php if ($_POST["keyTE"] == $rNombre11["keyTE"]) {
        echo 'selected=""';
    } ?>
...
?>
                        ...
                        while ($rNombre11 = mysql_fetch_array($resultaNombre11)) {
                            ...
                            ?>
                                ...
                                <option
                                <?php if ($_POST["keyOS"] == $rNombre11['keyOS']) {
                                    echo 'selected=""';
                                } ?>
                                    value="<?php echo $rNombre11["keyOS"]; ?>"><?php echo $rNombre11["descripcion"]; ?>
                                </option>
                            <?php } ?>
                        </select>
                        ...
                        <iframe src="fos.php?solicitud=<?php echo $_GET['solicitud']; ?>&test=20" frameborder="0" width="100%" align="left">
                ...
                <tr>
                    ...
                    <td width="451" scope="col"><label> </label>
                        <div align="left">
                            <?php
                            $sqlNombre11 = "SELECT * from sis_marcas
...
ORDER BY descripcion ASC";
                            ...
                            while ($rNombre11 = mysql_fetch_array($resultaNombre11)) {
                                ...
                                ?>
                                    <option
                                    <?php if ($_POST["keyMA"] == $rNombre11['keyMA']) {
                                        echo 'selected=""';
                                    } ?>
...
?>
                            ...
                            while ($rNombre11 = mysql_fetch_array($resultaNombre11)) {
                                ...
                                ?>
                                    <option
    <?php if ($_POST["keyTP"] == $rNombre11['keyTP']) {
        echo 'selected=""';
    } ?>
