...
<body>
 ...
 <h1 align="center" class="titulos">Cuentas Cerradas</h1>
 <form id="form2" name="form2" method="post" action="">
   ...
   <p align="center">
	   ...
	   <a href="javascript:ventanaSecundariaA('../ventanas/reporteVentasInternos.php?numeroE=<?php echo $numeroE; ?>&amp;nCuenta=<?php echo $nCuenta; ?>&amp;paciente=<?php echo $_POST['paciente']; ?>&amp;numeroConfirmacion=<?php echo $numeroConfirmacion; ?>&amp;hora1=<?php echo $hora1; ?>&amp;keyClientesInternos=<?php echo $myrow3['keyClientesInternos'];?>&amp;random=<?php echo $myrow7ab['random'];?>&amp;fechaInicial=<?php echo $_POST['fechaInicial'];?>&amp;fechaFinal=<?php echo $_POST['fechaFinal'];?>');"></a>  
   <p>&nbsp;</p>
  ...
  <div id="encabezado">
<p align="center">Folios cerrados internos</p>
</div>
<div id="contener">
<div id="liga1">
&nbsp; <br />
<a href="javascript:ventanaSecundariaA('../ventanas/reporteAlmacenSolicitanteInternos.php?numeroE=<?php echo $numeroE; ?>&nCuenta=<?php echo $nCuenta; ?>&paciente=<?php echo $_POST['paciente']; ?>&numeroConfirmacion=<?php echo $numeroConfirmacion; ?>&hora1=<?php echo $hora1; ?>&keyClientesInternos=<?php echo $myrow3['keyClientesInternos'];?>&random=<?php echo $myrow7ab['random'];?>&fechaInicial=<?php echo $_POST['fechaInicial'];?>&fechaFinal=<?php echo $_POST['fechaFinal'];?>&entidad=<?php echo $entidad;?>');">
Ventas internos</a><br />

<a href="javascript:ventanaSecundariaA('../ventanas/reporteHonorariosInternos.php?fechaInicial=<?php echo $_POST['fechaInicial'];?>&amp;fechaFinal=<?php echo $_POST['fechaFinal'];?>&entidad=<?php echo $entidad;?>');">
Honorarios</a>

<div id="liga2">
&nbsp; <br />
<a href="javascript:ventanaSecundariaA('../ventanas/detallesPxInternos.php?fechaInicial=<?php echo $_POST['fechaInicial'];?>&amp;fechaFinal=<?php echo $_POST['fechaFinal'];?>&amp;entidad=<?php echo $entidad;?>');">
Detalles px internos</a><br />
...
<div id="liga3">
&nbsp; <br />
<a href="javascript:ventanaSecundariaA('../ventanas/detallesFoliosVentaInternos.php?fechaInicial=<?php echo $_POST['fechaInicial'];?>&amp;fechaFinal=<?php echo $_POST['fechaFinal'];?>&amp;entidad=<?php echo $entidad;?>');">
