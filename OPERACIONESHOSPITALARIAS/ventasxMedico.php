...
<body>
 ...
 <h1 align="center" >Ventas Medicos </h1>
 ...
 <form id="form2" name="form2" method="post" >
   ...
   <table widtd="385" class="table-forma">
       ...
       <tr>
       <td widtd="207" scope="col"><div align="left">
       ...
       <td widtd="178" scope="col"><div align="center">
...
<input name="buscar" type="submit" src="../imagenes/btns/searchbutton.png"  id="buscar" value="buscar" />
   ...
   <p align="center">&nbsp;</p>
   <p align="center">
<a href="javascript:ventanaSecundaria5111('../ventanas/imprimirSaldosMedicos.php?nombreCompleto=<?php echo $_POST['nombreCompleto'];?>&numMedico=<?php echo $_POST['numMedico'];?>
    ...
    inputField     :    "campo_fecha2",     // id del campo de texto
     ...
     button     :    "lanzador2"     // el id del bot�n que lanzar� el calendario
		...
		new Autocomplete("nombreCompleto", function() {
			...
			return "/sima/cargos/medicosx.php?entidad=<?php echo $entidad;?>&q=" + tdis.value;
