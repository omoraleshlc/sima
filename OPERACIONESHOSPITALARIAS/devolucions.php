...
?>
	<tr  >   
<td height="24" bgcolor="<?php echo $color?>" ><div align="left"><?php echo $myrow['folioVenta'];
?></span></div></td>
      <td width="222" bgcolor="<?php echo $color?>" >
      ...
      <td width="238" bgcolor="<?php echo $color?>" ><?php 
...
?></td>
      <td width="65" bgcolor="<?php echo $color?>" ><div align="center"><?php echo $myrow['cuarto']
?></span></div></td>
      ...
      <td width="75" bgcolor="<?php echo $color?>" ><div align="center">
      ...
      <img src="../imagenes/btns/devolution.png" alt="Pacientes Activos" width="22" height="22" border="0" />      </a></div></td>
    </tr>
    <?php  }}?>
