...
<table width="385" class="table table-striped">
  <tr>
      ...
      <th width="41"  scope="col" >Datos</th>
    </tr>
      <tr>
        <?php 
$result=mysql_db_query($basedatos,$sSQL);
while($myrow = mysql_fetch_array($result)){ 
$nombrePaciente = $myrow['NOMBRE']." ".$myrow['APELLIDOS']." ".
$myrow['AMATERNO'];
$bandera+="1";
...
<?php } ?>
        ...
        <td bgcolor="<?php echo $color;?>" ><div align="center"><span >
          ...
          <?php if(!$myrow31['numeroE']){ ?>
          <a href="javascript:ventanaSecundaria1('../ventanas/ecEstudiantes.php?MATRICULA=<?php echo $myrow['MATRICULA'];?>')">
              Ver       </a>
          <?php } else { 
