...
<tr bgcolor="#ffffff" onMouseOver="bgColor='#87CEFF'" onMouseOut="bgColor='#ffffff'" >
    ...
    <td class="normal">
    <?php echo $myrow2['horaSolicitud']?>
</td>

<td class="normal">
    <?php echo $myrow2['numeroE'];?>
</td>
...
<a
	  ...
	  href="javascript:ventanaSecundaria2('../ventanas/cuadroClinico.php?keyClientesInternos=<?php echo $myrow['keyClientesInternos']; ?>&amp;seguro=<?php echo $_POST['seguro']; ?>&amp;medico=<?php echo $_POST['medico']; ?>&amp;usuario=<?php echo $usuario; ?>')">
    Edit
</a>
        <?php } else { ?>
        ---
...
<td class="normal" style="">
    <label class="normal">
	  ...
	  onclick="ventanaSecundaria3('../ventanas/antecedentesAnteriores.php?keyClientesInternos=<?php echo $myrow['keyClientesInternos'];?>&amp;nCuenta=<?php echo $myrow['nCuenta']; ?>&amp;almacen2=<?php echo $A; ?>&amp;seguro=<?php echo $_POST['seguro']; ?>&amp;numCliente=<?php echo $myrow['numeroE'];?>')">
           Edit
       </a>
